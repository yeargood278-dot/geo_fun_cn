...
$books = [
    ...
    'xb1'=> ['title' => '选择性必修1', 'status' => 'active', 'color' => '#27ae60', 'icon' => '🐶', 'desc' => '自然地理基础 (爱宠主题)'], 
    'xb2'=> ['title' => '选择性必修2', 'status' => 'active', 'color' => '#9b59b6', 'icon' => '🐰', 'desc' => '区域发展 (彼得兔主题)'], 
    'xb3'=> ['title' => '选择性必修3', 'status' => 'active', 'color' => '#e74c3c', 'icon' => '🐼', 'desc' => '资源与国家安全 (功夫熊猫主题)'], 
];

// ==========================================
// 2. 必修一 & 二 思维导图 (保留原样)
// ==========================================
$b1_mindmap = "graph TB\nRoot[🌍 必修第一册]:::rootClass\nsubgraph C1 [第一章 宇宙]\nC1S1(1.1 宇宙环境):::activeNode\nend\nRoot-->C1S1\nclassDef rootClass fill:#2c3e50,stroke:#fff,color:white;\nclassDef activeNode fill:#3498db,color:white;"; 
$b2_mindmap = "graph TB\nRoot[🔥 必修第二册]:::rootClass\nsubgraph C1 [第一章 人口]\nB2C1S1(1.1 人口分布):::activeNode\nend\nRoot-->B2C1S1\nclassDef rootClass fill:#d35400,color:white;\nclassDef activeNode fill:#e67e22,color:white;";
$xb1_mindmap = "graph TB\nRoot[🐶 选择性必修1]:::rootClass\nsubgraph C1 [第一章 地球的运动]\nXB1C1S1(1.1 自转和公转):::activeNode\nXB1C1S2(1.2 地理意义):::activeNode\nXB1C1QR(\"问题: 人造月亮\"):::specialNode\nXB1C1S1-->XB1C1S2-->XB1C1QR\nend\nRoot-->XB1C1S1\nclick XB1C1S1 \"section_learn.php?id=xb1c1s1\" \"进入课堂\"\nclick XB1C1S2 \"section_learn.php?id=xb1c1s2\" \"进入课堂\"\nclick XB1C1QR \"project_research.php?bid=xb1&open=0\" \"进入研究\"\nclassDef rootClass fill:#27ae60,stroke:#fff,color:white;classDef activeNode fill:#2ecc71,color:white;classDef specialNode fill:#f1c40f,color:white;";
$xb2_mindmap = "graph TB\nRoot[\"🐰 选择性必修2\"]:::rootClass\nsubgraph C1 [\"第一章 区域与区域发展\"]\nXB2C1S1(\"1.1 多种多样的区域\"):::activeNode\nXB2C1S2(\"1.2 整体性与关联性\"):::activeNode\nXB2C1QR(\"问题: 毛里求斯\"):::specialNode\nXB2C1S1-->XB2C1S2-->XB2C1QR\nend\nRoot-->XB2C1S1\nclick XB2C1S1 \"section_learn.php?id=xb2c1s1\" \"进入课堂\"\nclick XB2C1S2 \"section_learn.php?id=xb2c1s2\" \"进入课堂\"\nclick XB2C1QR \"project_research.php?bid=xb2&open=0\" \"进入研究\"\nclassDef rootClass fill:#9b59b6,stroke:#fff,color:white;classDef activeNode fill:#a569bd,color:white;classDef specialNode fill:#f39c12,color:white;";

// ==========================================
// 3. 选择性必修1 思维导图 (已修复跳转链接)
// ==========================================
$b1_mindmap = "
graph TB
    Root[🌍 必修第一册]:::rootClass
...
// ==========================================
// 5. 选择性必修1 思维导图 (严格对应 xzbx1_content.pdf)
// ==========================================
$xb1_mindmap = "
graph TB
    Root[🐶 选择性必修1]:::rootClass
    ...
    classDef inactiveNode fill:#bdc3c7,stroke:#95a5a6,color:white,cursor:not-allowed,rx:5,ry:5;
...
$research_projects_xb1 = [
    // --- 第一章 地球的运动 ---
    [
        'id' => 'xb1_c1_p1', 'icon' => '🌕', 'title' => '1.1 人类是否需要人造月亮 (教材)',
        'points' => '俄罗斯曾进行反射镜试验，试图将阳光反射到夜面。支持者认为可节约照明能源、辅助夜间救灾；反对者担心光污染、干扰天文观测及破坏生物昼夜节律。',
        'value' => '引导学生辩证看待技术进步与生态环境的关系，思考空间资源开发的伦理边界。'
    ],
    [
        'id' => 'xb1_c1_p2', 'icon' => '🕰️', 'title' => '1.2 校园日晷与太阳高度',
        'points' => '利用晷针影子在晷面上的位置变化来计时。晷针指向北极星，晷面与赤道平行。分析为什么夏季影子短、冬季影子长，以及地方时与标准时的差异。',
        'value' => '将抽象的太阳直射点移动、正午太阳高度角变化知识应用到实际观测中，培养实践能力。'
    ],
    [
        'id' => 'xb1_c1_p3', 'icon' => '🧭', 'title' => '1.3 寻找真正的北方：磁偏角',
        'points' => '指南针指的“北”（磁北）和地球自转轴的“北”（真北）并不重合，存在磁偏角。探究如何通过北极星或正午日影确定真北方向。',
        'value' => '深入理解地磁场与地理坐标系的区别，提升野外生存与定向导航的地理素养。'
    ],

    // --- 第二章 地表形态的塑造 ---
    [
        'id' => 'xb1_c2_p1', 'icon' => '🏝️', 'title' => '2.1 崇明岛的未来是什么样子 (教材)',
        'points' => '崇明岛受“北积南冲”规律影响（地转偏向力导致长江口南岸侵蚀、北岸堆积），正逐渐向北岸靠拢。同时人类围垦加速了岛屿扩大，但上游水库拦沙减缓了自然淤积。',
        'value' => '理解自然力量（地转偏向力、流水堆积）与人类活动（水库、围垦）对地貌的共同塑造作用。'
    ],
    [
        'id' => 'xb1_c2_p2', 'icon' => '⛰️', 'title' => '2.2 雅丹地貌：“魔鬼城”的成因',
        'points' => '分析西北干旱地区“魔鬼城”的形成机制。主要由强大的定向风力侵蚀（风蚀柱、风蚀垄）和间歇性流水冲刷共同作用于湖相沉积岩层而形成。',
        'value' => '探究外力作用（特别是风力）在干旱区地貌演化中的主导地位。'
    ],
    [
        'id' => 'xb1_c2_p3', 'icon' => '🏘️', 'title' => '2.3 寻找城市下的“古河道”',
        'points' => '许多现代城市建立在古河道之上。探究古河道对城市地基稳定性（易沉降）、地下水分布及地铁建设（易透水）的影响。',
        'value' => '将地貌学知识应用于城市规划与工程建设，关注地质安全。'
    ],

    // --- 第三章 大气的运动 ---
    [
        'id' => 'xb1_c3_p1', 'icon' => '⛰️', 'title' => '3.1 阿联酋“造山引雨”是否可行 (教材)',
        'points' => '阿联酋计划堆筑高山，利用地形抬升迫使湿润气流上升冷却，形成地形雨。面临工程量巨大、当地空气湿度不足及可能改变周边气候等挑战。',
        'value' => '思考人类改造气候的极限与边界，评估大型地球工程的可行性与生态风险。'
    ],
    [
        'id' => 'xb1_c3_p2', 'icon' => '🏙️', 'title' => '3.2 城市“热岛”与“雨岛”效应',
        'points' => '城市中心气温高于郊区（热岛），导致热空气上升，易在城区形成降水（雨岛）。分析城市化（硬化路面、废热排放、高楼阻挡）对局部微气候的影响。',
        'value' => '关注城市化带来的环境问题，应用热力环流原理解决实际生活中的气候现象。'
    ],
    [
        'id' => 'xb1_c3_p3', 'icon' => '📱', 'title' => '3.3 手机天气预报的准确率',
        'points' => '对比手机APP预报与实际天气的差异。探讨数值天气预报的原理（气团、锋面模型的计算）以及“蝴蝶效应”导致的预报误差。',
        'value' => '了解现代气象技术，培养收集数据、验证假设的科学探究精神。'
    ],

    // --- 第四章 水的运动 ---
    [
        'id' => 'xb1_c4_p1', 'icon' => '🧊', 'title' => '4.1 利用南极冰山解决沙特缺水 (教材)',
        'points' => '设想将南极冰山拖运至沙特。需解决运输动力、途经热带海域的融化损耗、对沿途海洋生态（降温）的影响以及国际法归属等问题。',
        'value' => '探讨跨区域资源调配的大胆设想，权衡工程经济效益与生态成本。'
    ],
    [
        'id' => 'xb1_c4_p2', 'icon' => '🏙️', 'title' => '4.2 “海绵城市”能解决内涝吗',
        'points' => '通过铺设透水砖、建造下凹式绿地，增加雨水下渗，减少地表径流。分析其在暴雨期间削峰错峰的作用及局限性。',
        'value' => '应用水循环原理（下渗、径流环节）解决城市内涝问题，推广生态城市理念。'
    ],
    [
        'id' => 'xb1_c4_p3', 'icon' => '🗑️', 'title' => '4.3 太平洋上的“垃圾大陆”',
        'points' => '太平洋环流将陆地和船只排放的塑料垃圾聚集在副热带高压中心，形成巨大的垃圾带。分析洋流在污染物输送与集聚中的作用。',
        'value' => '关注海洋环境污染，理解洋流对污染物的双重影响（扩散与富集）。'
    ],

    // --- 第五章 整体性与差异性 ---
    [
        'id' => 'xb1_c5_p1', 'icon' => '🌱', 'title' => '5.1 引入欧洲冷季型草坪是否合适 (教材)',
        'points' => '欧洲草坪喜湿润，引进我国西北干旱城市后成为“抽水机”，耗水量极大且易生病虫害。违背了“因地制宜”原则，应推广本地耐旱植被。',
        'value' => '树立因地制宜的生态建设观念，警惕盲目引进外来物种带来的生态负担。'
    ],
    [
        'id' => 'xb1_c5_p2', 'icon' => '🌲', 'title' => '5.2 塞罕坝林场的生态奇迹',
        'points' => '塞罕坝从“黄沙遮天日”变成“林海”，改善了当地小气候，涵养了水源，阻挡了风沙。体现了自然环境“牵一发而动全身”的整体性原理。',
        'value' => '理解生态修复的连锁正反馈效应，弘扬生态文明建设成就。'
    ],
    [
        'id' => 'xb1_c5_p3', 'icon' => '🏢', 'title' => '5.3 垂直森林：高楼上的自然带',
        'points' => '在摩天大楼上种植植物。低层种阔叶树，高层种针叶树或灌木（模拟垂直地带性）。需考虑高层风大、光照强、水分蒸发快等环境差异。',
        'value' => '将垂直地带性规律应用于现代建筑设计，探索人与自然和谐共存的新模式。'
    ]
];

$research_projects_xb2 = [
    // --- 第一章 区域与区域发展 ---
    [
        'id' => 'xb2_c1_p1', 
        'icon' => '🏝️', 
        'title' => '1.1 毛里求斯的发展模式可以复制吗 (教材)',
        'points' => '毛里求斯曾是单一依赖蔗糖农业的落后岛国，面临国土狭小、资源贫乏、远离大陆的困境。通过因地制宜，利用优越的地理位置和优美的风光，大力发展加工业、旅游业和金融业，实现了经济腾飞，被称为“非洲样板”。',
        'value' => '探讨资源贫乏的小国或地区如何发挥比较优势（区位、环境、政策），实现区域发展的“逆袭”。'
    ],
    [
        'id' => 'xb2_c1_p2', 
        'icon' => '🏠', 
        'title' => '1.2 南北民居差异与自然环境',
        'points' => '我国北方民居墙体厚、窗户小、屋顶坡度小（适应寒冷干燥、降雪少）；南方民居墙体薄、窗户大、屋顶坡度大（适应炎热潮湿、降雨多）。这些差异深刻反映了区域自然环境对人类活动的影响。',
        'value' => '理解区域自然环境（气候）对地域文化（建筑风格）的塑造作用。'
    ],
    [
        'id' => 'xb2_c1_p3', 
        'icon' => '🐟', 
        'title' => '1.3 稻田养鱼：传统农业的智慧',
        'points' => '浙江青田的稻鱼共生系统：鱼吃稻田害虫和杂草，排泄物肥田；水稻为鱼遮阴。这是一种高效的生态农业模式，体现了区域要素（生物、水、土、人）的良性关联。',
        'value' => '分析区域内部要素如何通过精巧设计实现整体效益最大化，关注农业文化遗产的保护。'
    ],
    // --- 第二章 (本次新增) ---
    [
        'id' => 'xb2_c2_p1', 
        'icon' => '🏺', 
        'title' => '2.1 景德镇还要不要走“世界瓷都”之路 (教材)',
        'points' => '景德镇因瓷土资源丰富而兴，但随着优质高岭土资源的枯竭，面临发展困境。是继续依赖传统瓷业，还是转型？结论：应保留“瓷都”品牌，但转型为文化创意和高技术陶瓷产业。',
        'value' => '探讨资源枯竭型城市如何在保护传统品牌的同时实现产业升级。'
    ],
    [
        'id' => 'xb2_c2_p2', 
        'icon' => '🏜️', 
        'title' => '2.2 “绿色长城”：三北防护林',
        'points' => '分析“三北”防护林工程在治理风沙、改善生态环境方面的巨大作用，以及在单一树种种植中遇到的病虫害问题。',
        'value' => '评估大型生态工程的利弊，理解生态治理的长期性与复杂性。'
    ],
    [
        'id' => 'xb2_c2_p3', 
        'icon' => '⛏️', 
        'title' => '2.3 废弃矿坑变身记',
        'points' => '以上海深坑酒店为例，探讨如何利用废弃的采石场或矿坑，开发旅游、休闲项目，变废为宝，实现生态修复与经济效益双赢。',
        'value' => '开拓资源枯竭型城市转型的创新思维（工业遗产旅游）。'
    ],
    // --- 第三章 (本次新增) ---
    [
        'id' => 'xb2_c3_p1', 
        'icon' => '🚗', 
        'title' => '3.1 汽车工业能否带动家乡的发展 (教材)',
        'points' => '汽车工业产业链长（涉及钢铁、电子、玻璃等）、关联度高、就业吸纳能力强。但同时也面临投资大、技术要求高、市场竞争激烈的风险。全球化生产体系下，需考虑本地是否具备配套优势。',
        'value' => '分析主导产业的选择依据，理解产业对区域综合实力的带动作用。'
    ],
    [
        'id' => 'xb2_c3_p2', 
        'icon' => '📱', 
        'title' => '3.2 “直播带货”如何改变乡村产业',
        'points' => '数字经济（电商直播）打破了空间限制，使偏远地区的农产品能直达消费者。这改变了传统的销售渠道，倒逼乡村农业标准化、品牌化转型。',
        'value' => '探讨新技术（互联网+）对传统产业结构升级的推动力。'
    ],
    [
        'id' => 'xb2_c3_p3', 
        'icon' => '🏙️', 
        'title' => '3.3 为什么大城市会有“虹吸效应”',
        'points' => '大城市凭借优质的公共服务（医疗、教育）和就业机会，像吸尘器一样吸走周边中小城市的人口、资金和技术，导致周边“灯下黑”。',
        'value' => '辩证看待城市辐射功能中的“虹吸”与“扩散”阶段。'
    ],
    // --- 第四章 (本次新增) ---
    [
        'id' => 'xb2_c4_p1', 
        'icon' => '💧', 
        'title' => '4.1 该不该引藏水入疆 (教材)',
        'points' => '新疆光热足但缺水，西藏水多。构想从雅鲁藏布江等河流引水入疆。这能解决新疆缺水，造就“塞外江南”，但面临极高的工程难度（穿越青藏高原）、巨额投资以及对下游国家和生态环境的潜在影响。',
        'value' => '探讨跨流域调水的极限设想，权衡工程效益与生态、地缘政治风险，培养综合思维和批判性思维。'
    ],
    [
        'id' => 'xb2_c4_p2', 
        'icon' => '🏭', 
        'title' => '4.2 产业转移是“馅饼”还是“陷阱”',
        'points' => '承接产业转移能带来就业和GDP（馅饼），但也可能带来高能耗、高污染（陷阱）。探讨发展中国家如何在承接转移时进行筛选，避免成为“污染避难所”。',
        'value' => '辩证分析产业转移的双重影响，树立绿色发展观。'
    ],
    [
        'id' => 'xb2_c4_p3', 
        'icon' => '🚄', 
        'title' => '4.3 “一带一路”上的中国味道',
        'points' => '通过中欧班列，中国的茶叶、电子产品运往欧洲，欧洲的红酒、汽车运回中国。分析交通走廊如何演变为经济走廊，促进沿线国家的文化与经济交流。',
        'value' => '理解国际合作在经济全球化背景下的实际意义。'
    ]
];

// --- XB3 项目 (选择性必修3) ---
$research_projects_xb3 = [
    [
        'id' => 'xb3_c1_p1', 
        'icon' => '👣', 
        'title' => '第一章：我们的生态足迹有多大',
        'points' => '
            <div class="mt-2">
                <span class="badge bg-warning text-dark mb-2">项目一：测测你的脚印</span><br>
                生态足迹是指维持一个人生活所需的<b>生产土地</b>和<b>吸碳土地</b>面积。利用计算器算算，如果全球人都像你一样生活，需要几个地球？（目前全球平均需要1.7个地球！）
            </div>
            <div class="mt-3">
                <span class="badge bg-danger mb-2">项目二：透支的账单</span><br>
                分析<b>“碳足迹”</b>在生态足迹中的占比。为什么发达国家的生态足迹远大于发展中国家？这说明了生活方式、消费水平与资源消耗的直接关系。
            </div>
            <div class="mt-3">
                <span class="badge bg-success mb-2">项目三：减负行动</span><br>
                设计你的<b>低碳生活方案</b>。少吃肉（肉类足迹大）、多坐公交、减少浪费。目标：将个人生态足迹减少20%。
            </div>',
        'value' => '<b>价值：</b> 将抽象的资源消耗量化，树立危机意识，理解“地球界限”和可持续发展的紧迫性。'
    ],
    // 占位后续章节
    [
        'id' => 'xb3_c2_p1', 'icon' => '🌾', 'title' => '第二章：如何“藏粮于地”', 'points' => '待解锁...', 'value' => '关注粮食安全战略。'
    ],
    [
        'id' => 'xb3_c3_p1', 'icon' => '☢️', 'title' => '第三章：是否应该发展核能', 'points' => '待解锁...', 'value' => '权衡能源需求与环境风险。'
    ],
    [
        'id' => 'xb3_c4_p1', 'icon' => '📋', 'title' => '第四章：中学生环境意识调查', 'points' => '待解锁...', 'value' => '社会实践与统计分析。'
    ],
    // --- 第二章 (本次新增) ---
    [
        'id' => 'xb3_c2_p1', 
        'icon' => '🌾', 
        'title' => '2.1 如何“藏粮于地” (教材)',
        'points' => '“藏粮于地”强调耕地的生产能力。1. 严守耕地红线（数量）；2. 建设高标准农田（质量）；3. 轮作休耕（休养生息）。一旦需要，这些地能立刻产出粮食。',
        'value' => '理解粮食安全的根本在于耕地，树立可持续农业发展观。'
    ],
    [
        'id' => 'xb3_c2_p2', 
        'icon' => '🔋', 
        'title' => '2.2 新能源汽车能保障石油安全吗',
        'points' => '我国石油对外依存度高。推广新能源汽车（电动/氢能）可以减少对燃油的消耗，降低石油进口依赖，从而提升国家能源安全。',
        'value' => '探讨能源消费结构转型对国家安全的战略意义。'
    ],
    [
        'id' => 'xb3_c2_p3', 
        'icon' => '🌊', 
        'title' => '2.3 海上粮仓：深远海养殖',
        'points' => '利用我国广阔的海洋国土，发展深海网箱养殖和海洋牧场，获取优质蛋白，减轻陆地耕地的粮食压力。',
        'value' => '树立大食物观，向海洋要食物。'
    ],
    // --- 第三章 (本次新增) ---
    [
        'id' => 'xb3_c3_p1', 
        'icon' => '⚛️', 
        'title' => '3.1 是否应该发展核能 (教材)',
        'points' => '核能清洁高效、能量密度大，能优化能源结构，减少碳排放。但核泄漏（如切尔诺贝利、福岛）后果毁灭性，且核废料处理难。发展核能需在确保安全的前提下进行。',
        'value' => '辩证看待高风险、高收益的技术，权衡环境安全与资源安全。'
    ],
    [
        'id' => 'xb3_c3_p2', 
        'icon' => '🦠', 
        'title' => '3.2 外来物种是“天使”还是“恶魔”',
        'points' => '小龙虾是美味，互花米草是护堤能手（天使）；但如果不加控制，它们可能挤占本地物种生存空间，破坏生态平衡，造成生物入侵（恶魔）。',
        'value' => '理解生物安全是国家安全的重要组成部分。'
    ],
    [
        'id' => 'xb3_c3_p3', 
        'icon' => '🌡️', 
        'title' => '3.3 气候变化：马尔代夫的求救信',
        'points' => '马尔代夫在水下召开内阁会议，呼吁全球关注海平面上升。对于小岛国，气候变化关乎亡国灭种的生存危机。',
        'value' => '树立人类命运共同体意识，关注全球环境问题。'
    ],
    // --- 第四章 (本次新增) ---
    [
        'id' => 'xb3_c4_p1', 
        'icon' => '📋', 
        'title' => '4.1 如何做环保意识问卷调查 (教材)',
        'points' => '问卷设计步骤：1. 确定主题（如垃圾分类）；2. 设计问题（封闭式/开放式）；3. 发放与回收；4. 统计分析。注意问题要客观、简洁，避免诱导性语言。',
        'value' => '掌握社会调查的基本方法，培养从数据中发现环境问题的能力。'
    ],
    [
        'id' => 'xb3_c4_p2', 
        'icon' => '♻️', 
        'title' => '4.2 个人能为碳中和做什么',
        'points' => '计算个人碳足迹（Carbon Footprint）。行为改变：少点外卖（减少一次性塑料）、多坐公交（低碳出行）、随手关灯。积少成多，聚沙成塔。',
        'value' => '将宏大的国家战略落实到个人的微小行动中，增强公民责任感。'
    ],
    [
        'id' => 'xb3_c4_p3', 
        'icon' => '🤝', 
        'title' => '4.3 模拟联合国气候大会',
        'points' => '角色扮演：发达国家（有钱有技术但历史排放多） vs 发展中国家（急需发展但资金技术缺）。辩论议题：减排责任如何分配？资金技术如何转让？',
        'value' => '深入理解“共同但有区别的责任”原则，体验国际环境合作的复杂性。'
    ]
     //后续章节占位
];
...
'xb1c1s1' => [
    'title' => '1.1 地球的自转和公转',
    'ppt' => [
        ['role'=>'max', 'title'=>'特工集结！', 'content'=>'嘿！我是<b>麦克</b>。欢迎加入“爱宠特工队”地理分部！<br>今天我们要追踪一个大家伙——<b>地球</b>。<br>它一刻不停地在乱动！<br>它不仅自己转（自转），还绕着太阳跑（公转）。<br>这不仅决定了我们什么时候遛弯，还决定了什么时候换毛！', 'visual'=>'icon_earth', 'anim_type'=>'fadeIn'],
        ['role'=>'snowball', 'title'=>'自转：疯狂的陀螺', 'content'=>'我是<b>小白</b>！地球就像我一样，是个疯狂的陀螺！<br><b>轴心：</b> 地轴（北端指向北极星）。<br><b>方向：</b> 自西向东。<br><b>诀窍：</b> 从北极看是<b>逆时针</b>（N逆），从南极看是<b>顺时针</b>（S顺）。<br>转晕了吗？我也是！', 'visual'=>'css_rotation', 'anim_type'=>'rotateIn'],
        ['role'=>'chloe', 'title'=>'挑剔的时间：周期', 'content'=>'我是<b>克洛伊</b>。关于“一天”有多长，我可是很挑剔的。<br>1. <b>太阳日</b>：24小时。这是你们人类看太阳算的时间，方便约饭。<br>2. <b>恒星日</b>：23时56分4秒。这才是地球<b>转360°的真正时间</b>。<br>少的3分56秒去哪了？被公转吃掉了。', 'visual'=>'css_clock', 'anim_type'=>'fadeInLeft'],
        ['role'=>'duke', 'title'=>'速度大比拼', 'content'=>'我是<b>杜老大</b>。地球上各地的速度不一样哦。<br>1. <b>角速度</b>：除了南北极点是0，大家都是15°/小时。<br>2. <b>线速度</b>：<b>赤道最快</b>（1670km/h），越往两极越慢，极点不动。<br>想把球扔得远？去赤道扔！', 'visual'=>'css_speed_map', 'anim_type'=>'zoomIn'],
        ['role'=>'gidget', 'title'=>'公转：浪漫圆舞曲', 'content'=>'我是<b>啾啾</b>。地球绕着太阳跳舞，这叫公转。<br><b>方向：</b> 也是自西向东。<br><b>轨道：</b> 近似正圆的椭圆，太阳在焦点上。<br><b>周期：</b> 一年。<br><b>回归年</b>：365日5时48分46秒（平常说的一年）。<br><b>恒星年</b>：365日6时9分10秒（真正的周期）。', 'visual'=>'css_orbit', 'anim_type'=>'fadeInRight'],
        ['role'=>'max', 'title'=>'公转速度：近快远慢', 'content'=>'记住这个节奏：<br><b>近日点 (1月初)</b>：离太阳近，跑得<b>快</b>（像看见了骨头）。<br><b>远日点 (7月初)</b>：离太阳远，跑得<b>慢</b>（像吃撑了）。<br>这就是为什么北半球的冬天比夏天短几天的原因！', 'visual'=>'css_perihelion', 'anim_type'=>'pulse'],
        ['role'=>'snowball', 'title'=>'黄赤交角：歪打正着', 'content'=>'地球是歪着身子跑的！<br><b>赤道面</b>（自转）和<b>黄道面</b>（公转）有个夹角，叫<b>黄赤交角</b>。<br>目前度数：<b>23°26′</b>。<br>正是因为歪着，太阳直射点才会在地球上跑来跑去！', 'visual'=>'css_angle', 'anim_type'=>'swing'],
        ['role'=>'duke', 'title'=>'直射点的回归运动', 'content'=>'太阳直射点就像我追的球，在南北回归线之间来回跑。<br><b>夏至 (6.22)</b>：直射北回归线。<br><b>冬至 (12.22)</b>：直射南回归线。<br><b>春/秋分</b>：直射赤道。<br>这个来回跑的周期叫<b>回归年</b>。', 'visual'=>'css_sun_move', 'anim_type'=>'slideInUp'],
        ['role'=>'pops', 'title'=>'中国智慧：郭守敬', 'content'=>'我是<b>巴布</b>。给你们讲个古。<br>元代的<b>郭守敬</b>编了《授时历》。<br>他测出的回归年长度是365.2425日，和现代科技测的一模一样！<br>但他比西方早了300年！Respect！', 'visual'=>'icon_star', 'anim_type'=>'fadeIn'],
        ['role'=>'max', 'title'=>'第一关总结', 'content'=>'特工们，汇报重点：<br>1. 自转：南顺北逆，线速度赤道最大。<br>2. 公转：1月初近日点快，7月初远日点慢。<br>3. 黄赤交角：23°26′，决定了太阳直射范围。<br>准备好接受考核了吗？', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
    ],
    'quiz' => [
        'part_a' => [
            ['type'=>'single', 'q'=>'地球自转的真正周期是？', 'opt'=>['A. 24小时','B. 23时56分4秒','C. 365日','D. 一个太阳日'], 'ans'=>'B', 'expl'=>'恒星日（23时56分4秒）是地球自转360°的时间。'],
            ['type'=>'single', 'q'=>'地球自转线速度最大的地方是？', 'opt'=>['A. 南北极点','B. 南北纬60°','C. 赤道','D. 南北回归线'], 'ans'=>'C', 'expl'=>'线速度由赤道向两极递减，赤道周长最长，速度最快。'],
            ['type'=>'single', 'q'=>'从北极上空看，地球自转方向是？', 'opt'=>['A. 顺时针','B. 逆时针','C. 自东向西','D. 垂直向下'], 'ans'=>'B', 'expl'=>'北逆南顺。'],
            ['type'=>'single', 'q'=>'地球公转速度最慢的时候是？', 'opt'=>['A. 1月初','B. 7月初','C. 夏至日','D. 冬至日'], 'ans'=>'B', 'expl'=>'7月初位于远日点，公转速度最慢。'],
            ['type'=>'single', 'q'=>'目前的黄赤交角度数是？', 'opt'=>['A. 66°34′','B. 23°26′','C. 90°','D. 0°'], 'ans'=>'B', 'expl'=>'黄赤交角约为23°26′。'],
            ['type'=>'single', 'q'=>'当太阳直射点位于南回归线时，是北半球的？', 'opt'=>['A. 春分日','B. 夏至日','C. 秋分日','D. 冬至日'], 'ans'=>'D', 'expl'=>'冬至日太阳直射南回归线。'],
            ['type'=>'single', 'q'=>'编制《授时历》的中国古代天文学家是？', 'opt'=>['A. 张衡','B. 祖冲之','C. 郭守敬','D. 沈括'], 'ans'=>'C', 'expl'=>'元代郭守敬。'],
            ['type'=>'multi', 'q'=>'【多选】关于地球自转角速度，正确的是？', 'opt'=>['A. 全球各地都相等','B. 南北极点为0','C. 除极点外约为15°/小时','D. 赤道最大'], 'ans'=>'BC', 'expl'=>'除极点外，全球角速度相等。'],
            ['type'=>'multi', 'q'=>'【多选】地球公转的轨道特征？', 'opt'=>['A. 近似正圆的椭圆','B. 太阳位于中心','C. 太阳位于一个焦点上','D. 轨道面叫黄道面'], 'ans'=>'ACD', 'expl'=>'太阳位于椭圆的一个焦点上，不是中心。'],
            ['type'=>'multi', 'q'=>'【多选】太阳直射点的移动范围是？', 'opt'=>['A. 南北极圈之间','B. 南北回归线之间','C. 23°26′N 到 23°26′S','D. 赤道两侧'], 'ans'=>'BC', 'expl'=>'受黄赤交角限制，直射点在回归线之间移动。']
        ],
        'part_b' => [
            ['title'=>'🐶 麦克的推理', 'q'=>'如果黄赤交角变大（比如变成30°），地球上的五带会怎么变？', 'ans'=>'<b>热带和寒带变大，温带变小。</b><br>热带范围是南北回归线之间（2×交角），交角变大，热带变大。寒带是极圈以内（90°-交角），交角变大，极圈度数变小（纬度更低），寒带范围扩大。'],
            ['title'=>'🐰 小白的计算', 'q'=>'我们要发射一颗地球同步卫星，应该在什么地方发射最省燃料？向哪个方向发？', 'ans'=>'<b>在赤道，向东发射。</b><br>原因：赤道自转线速度最大，向东发射可以利用地球自转的惯性（离心力），获得最大的初速度，从而节省燃料。'],
            ['title'=>'🐱 克洛伊的疑问', 'q'=>'既然1月初地球离太阳最近，为什么北半球反而是冬天？', 'ans'=>'因为<b>季节主要由太阳高度（直射点位置）决定</b>。<br>1月初虽然距离近，但太阳直射南半球，北半球正午太阳高度小，白昼短，接收的热量少，所以是冬天。距离的影响远小于直射点的影响。']
        ]
    ]
],
// --- XB1 1.2 地球运动的地理意义 ---
'xb1c1s2' => [
    'title' => '1.2 地球运动的地理意义',
    'ppt' => [
        ['role'=>'max', 'title'=>'F-22的失误', 'content'=>'特工们！有个真实案例（教材P7）：<br>美军F-22战机飞越180°经线时，系统突然崩溃。<br>因为它们忽略了<b>“国际日界线”</b>！<br>地球自转带来了昼夜和时差，搞不清时间，可是会迷失在时空里的！', 'visual'=>'icon_plane', 'anim_type'=>'fadeIn'],
        ['role'=>'snowball', 'title'=>'昼夜交替：黑白无常', 'content'=>'我是<b>小白</b>。太阳只能照亮地球的一半。<br><b>昼半球</b>：亮的那半。<br><b>夜半球</b>：黑的那半。<br><b>晨昏线</b>：分界线。顺着转，从黑进白叫<b>晨线</b>（日出），从白进黑叫<b>昏线</b>（日落）。<br>周期：1个太阳日（24小时）。', 'visual'=>'css_day_night', 'anim_type'=>'rotateIn'],
        ['role'=>'chloe', 'title'=>'时差：不想起床', 'content'=>'地球自西向东转，<b>东边比西边先看到太阳</b>。<br>所以东边的时间早。<br><b>地方时</b>：经度每差15°，时间差1小时。<br>这就是为什么我在纽约吃晚饭，麦克在伦敦已经睡着了。', 'visual'=>'css_clock', 'anim_type'=>'fadeInLeft'],
        ['role'=>'duke', 'title'=>'时区与区时', 'content'=>'全球分了24个时区，每个跨15°。<br><b>区时</b> = 该时区中央经线的地方时。<br><b>北京时间</b> = 东八区的区时 = 120°E的地方时。<br>公式：<b>所求 = 已知 ± 时差</b>（东加西减）。', 'visual'=>'icon_chart', 'anim_type'=>'zoomIn'],
        ['role'=>'gidget', 'title'=>'国际日界线：穿越神器', 'content'=>'神奇的<b>180°经线</b>。<br>东十二区（最早）和西十二区（最晚）紧挨着。<br>向东跨过它：<b>日期减一天</b>（回到昨天）。<br>向西跨过它：<b>日期加一天</b>（进入明天）。<br>F-22就是因为没处理好这个跳变才死机的！', 'visual'=>'css_date_line', 'anim_type'=>'slideInRight'],
        ['role'=>'pops', 'title'=>'地转偏向力', 'content'=>'在地球上跑直线会跑偏！<br>受<b>地转偏向力</b>影响：<br><b>北右南左，赤道不偏</b>。<br>这影响了风向、洋流，甚至河流哪边被冲得更厉害（北半球冲右岸）。', 'visual'=>'css_coriolis', 'anim_type'=>'pulse'],
        ['role'=>'snowball', 'title'=>'昼夜长短的变化', 'content'=>'<b>直射点在哪，哪边就昼长夜短。</b><br>夏至（直射北）：北半球昼最长，北极圈极昼。<br>冬至（直射南）：北半球夜最长，北极圈极夜。<br>春秋分：全球昼夜平分。', 'visual'=>'css_day_length', 'anim_type'=>'fadeIn'],
        ...
        ['role'=>'duke', 'title'=>'四季与五带', 'content'=>'根据热量，地球分五带：<br><b>热带</b>（有直射）、<b>温带</b>（四季分明）、<b>寒带</b>（有极昼极夜）。<br>我国大部分在北温带。<br>二十四节气就是古人总结的智慧，指导农事。', 'visual'=>'icon_tree', 'anim_type'=>'fadeIn'],
        ['role'=>'max', 'title'=>'第二关总结', 'content'=>'特工们，记住：<br>1. 东早西晚算时差，日界线上换日期。<br>2. 北右南左地转力。<br>3. 直射点决定昼夜长短和太阳高度。<br>4. 四季五带由此生。<br>现在，开始终极考核！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
    ],
    'quiz' => [
        'part_a' => [
            ['type'=>'single', 'q'=>'北京时间是指？', 'opt'=>['A. 北京的地方时','B. 120°E的地方时','C. 东八区的区时','D. B和C'], 'ans'=>'D', 'expl'=>'北京时间是东八区区时，即120°E的地方时。'],
            ['type'=>'single', 'q'=>'从东十二区向东越过国际日界线，日期应该？', 'opt'=>['A. 加上一天','B. 减去一天','C. 不变','D. 减去一小时'], 'ans'=>'B', 'expl'=>'东十二区最早，西十二区最晚（昨天），向东跨过是回到昨天，减一天。'],
            ['type'=>'single', 'q'=>'北半球夏至日，下列说法正确的是？', 'opt'=>['A. 北极圈出现极夜','B. 北京昼长夜短','C. 太阳直射南回归线','D. 地球公转速度最快'], 'ans'=>'B', 'expl'=>'夏至直射北回归线，北半球昼长夜短。'],
            ['type'=>'single', 'q'=>'受地转偏向力影响，长江下游入海口的江水主要冲刷？', 'opt'=>['A. 南岸','B. 北岸','C. 泥沙堆积在南岸','D. 两岸一样'], 'ans'=>'A', 'expl'=>'北半球向右偏，江水流向东方，右侧是南岸，侵蚀严重。'],
            ['type'=>'single', 'q'=>'晨昏线上，太阳高度角是？', 'opt'=>['A. 0°','B. 90°','C. 45°','D. 23°26′'], 'ans'=>'A', 'expl'=>'晨昏线是昼夜交界，太阳位于地平线上，高度为0。'],
            ['type'=>'single', 'q'=>'二十四节气中，白昼最长的是？', 'opt'=>['A. 春分','B. 夏至','C. 秋分','D. 冬至'], 'ans'=>'B', 'expl'=>'夏至日北半球白昼最长。'],
            ['type'=>'single', 'q'=>'如果不考虑地形，在我国建房，大门和窗户应朝向？', 'opt'=>['A. 东','B. 南','C. 西','D. 北'], 'ans'=>'B', 'expl'=>'北半球正午太阳在南方，朝南采光好。'],
            ['type'=>'multi', 'q'=>'【多选】影响正午太阳高度的因素？', 'opt'=>['A. 纬度','B. 季节（直射点位置）','C. 经度','D. 地形'], 'ans'=>'AB', 'expl'=>'正午太阳高度只与纬度和直射点纬度有关。'],
            ['type'=>'multi', 'q'=>'【多选】五带的划分界线是？', 'opt'=>['A. 回归线','B. 极圈','C. 赤道','D. 本初子午线'], 'ans'=>'AB', 'expl'=>'回归线界定热带，极圈界定寒带。'],
            ['type'=>'multi', 'q'=>'【多选】若黄赤交角变为0°，则？', 'opt'=>['A. 全球全年昼夜平分','B. 无四季变化','C. 太阳永远直射赤道','D. 极圈内无极昼极夜'], 'ans'=>'ABCD', 'expl'=>'直射点不移动，所有季节和昼夜长短变化消失。']
        ],
        'part_b' => [
            ['title'=>'🐰 小白的诡计', 'q'=>'小白想过两次生日，他应该怎么做？（利用日界线）', 'ans'=>'他应该<b>自西向东</b>越过国际日界线。<br>比如在东十二区过完生日后，马上坐飞机向东飞到西十二区。因为西十二区比东十二区晚一天（是昨天），那里还是他的生日，这样就能再过一次！'],
            ['title'=>'🐶 麦克的导航', 'q'=>'在北半球发射远程导弹，为了命中正北方的目标，瞄准时应该偏左一点还是偏右一点？', 'ans'=>'应该<b>偏左一点（向西偏）</b>。<br>因为导弹在飞行中受地转偏向力影响会向右（东）偏。为了抵消这个偏差，发射时要人为向左修正。'],
            ['title'=>'🧱 楼间距的秘密', 'q'=>'同样高度的楼房，在哈尔滨建得密一点，还是在广州建得密一点？为什么？', 'ans'=>'在<b>广州</b>可以建得密一点。<br>哈尔滨纬度高，冬至日正午太阳高度角小，影子特别长，为了不挡光，楼间距必须大。广州纬度低，太阳高度角大，影子短，楼间距可以小。']
        ]
    ]
],
...
'xb1c3s1' => [
    ...
    'ppt' => [
        ...
        ['role'=>'pops', 'title'=>'案例：台风“莫兰蒂”', 'content'=>'台风是强烈的<b>热带气旋</b>。<br>2016年中秋节，“莫兰蒂”袭击厦门。<br>它中心气压极低，风力极大。<br><b>台风眼：</b> 中心反而无风无雨（下沉气流）。<br><b>台风眼壁：</b> 风力最强，暴雨最猛的地方。<br>虽然它破坏力大，但也能带来淡水，缓解高温。', 'visual'=>'icon_storm', 'anim_type'=>'pulse'],
        ['role'=>'max', 'title'=>'如何避险？', 'content'=>'遇到恶劣天气怎么办？<br>1. <b>冷锋寒潮</b>：多穿衣，保护农作物。<br>2. <b>台风</b>：船只回港，加固门窗，别出门！<br>3. <b>看天气预报</b>：认准▲（冷锋）和●（暖锋）符号。<br>只要准备充分，特工们就能安全度过！', 'visual'=>'icon_shield', 'anim_type'=>'zoomIn'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'暖锋降水主要发生在？', 'opt'=>['A. 锋前','B. 锋后','C. 锋线左右','D. 锋面下方'], 'ans'=>'A', 'expl'=>'暖气团沿锋面爬升，降水区主要在锋前。冷锋降水主要在锋后。'],
            ['type'=>'single', 'q'=>'台风中心（台风眼）的天气特点是？', 'opt'=>['A. 狂风暴雨','B. 阴雨连绵','C. 风平浪静，晴朗','D. 大雪纷飞'], 'ans'=>'C', 'expl'=>'台风眼盛行下沉气流，天气晴朗无风。'],
            ['type'=>'single', 'q'=>'“一场秋雨一场寒”描述的是哪种天气系统？', 'opt'=>['A. 暖锋','B. 冷锋','C. 准静止锋','D. 气旋'], 'ans'=>'B', 'expl'=>'秋季冷空气南下形成冷锋，带来降雨和降温。'],
            ['type'=>'single', 'q'=>'关于准静止锋，说法正确的是？', 'opt'=>['A. 移动迅速','B. 多晴朗天气','C. 冷暖气团势力相当','D. 只出现在冬季'], 'ans'=>'C', 'expl'=>'冷暖气团势均力敌，锋面移动缓慢，形成连续性阴雨。'],
            ['type'=>'multi', 'q'=>'【多选】影响我国的主要气象灾害有？', 'opt'=>['A. 寒潮','B. 台风','C. 地震','D. 洪涝'], 'ans'=>'ABD', 'expl'=>'地震属于地质灾害，不是气象灾害。'],
            ['type'=>'multi', 'q'=>'【多选】关于气旋与反气旋，正确的是？', 'opt'=>['A. 气旋中心气压低','B. 反气旋中心气流下沉','C. 气旋多带来阴雨天气','D. 反气旋控制下多狂风暴雨'], 'ans'=>'ABC', 'expl'=>'反气旋控制下多晴朗天气。'],
            ['type'=>'multi', 'q'=>'【多选】冷锋过境后的天气特征？', 'opt'=>['A. 气温下降','B. 气压升高','C. 天气转晴','D. 连续性降水'], 'ans'=>'ABC', 'expl'=>'冷锋过境后受冷气团控制，低温高压晴朗。']
        ],
        'part_b' => [
            ['title'=>'🐰 小白的战术', 'q'=>'小白在北方寒潮来袭前，给农作物盖上了塑料大棚。这是为了防御什么？原理是什么？', 'ans'=>'防御<b>冻害</b>。<br>原理：大棚可以增强大气逆辐射（保温作用），减少地面热量散失，防止农作物被冷锋带来的剧烈降温冻死。'],
            ['title'=>'🐶 麦克的航海', 'q'=>'麦克在海上航行，收到预报说前方有一个低压中心（气旋）。为了避开大风浪，他应该往中心开还是往外围开？', 'ans'=>'往<b>外围</b>开。<br>原因：气旋中心附近（尤其是台风眼壁）风力最大，浪最高。越向外围，风力相对越小。'],
...
'xb1c3s2' => [
    ...
    'ppt' => [
        ...
        ['role'=>'chloe', 'title'=>'海陆分布打破规则', 'content'=>'地球表面并不均匀。陆地和海洋热力性质不同。<br><b>北半球：</b> 陆地面积大，把气压带切断了！<br><b>夏季：</b> 陆地热（低压），切断了副热带高压（保留在海洋上）。<br><b>冬季：</b> 陆地冷（高压），切断了副极地低压。<br><b>南半球：</b> 海洋多，气压带比较完整（特别是西风漂流）。', 'visual'=>'icon_map_scatter', 'anim_type'=>'fadeInRight'],
        ['role'=>'pops', 'title'=>'季风环流', 'content'=>'海陆热力差异造就了<b>季风</b>（东亚最典型）。<br><b>冬季：</b> 风从陆地吹向海洋（西北风）-> 寒冷干燥。<br><b>夏季：</b> 风从海洋吹向陆地（东南风）-> 高温多雨。<br>南亚的夏季风（西南季风）更厉害，是南半球东南信风越过赤道变来的！', 'visual'=>'icon_wind', 'anim_type'=>'pulse'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'南半球气压带基本呈带状分布，原因是？', 'opt'=>['A. 陆地面积大','B. 海洋面积占绝对优势','C. 地势平坦','D. 没有季风'], 'ans'=>'B', 'expl'=>'南半球海洋面积广阔，性质均一，气压带未被破坏。'],
            ['type'=>'single', 'q'=>'东亚冬季风的风向是？', 'opt'=>['A. 东南风','B. 西南风','C. 东北风','D. 西北风'], 'ans'=>'D', 'expl'=>'东亚冬季风从蒙古-西伯利亚高压吹向太平洋，为西北风。'],
            ['type'=>'single', 'q'=>'形成三圈环流的主要因素是？', 'opt'=>['A. 海陆热力性质差异','B. 地形起伏','C. 高低纬受热不均和地转偏向力','D. 洋流运动'], 'ans'=>'C', 'expl'=>'受热不均产生大气运动，地转偏向力使其偏转形成三圈。'],
            ['type'=>'single', 'q'=>'关于气压带风带的季节移动，正确的是？', 'opt'=>['A. 夏季北移，冬季南移','B. 随太阳直射点移动而移动','C. 移动幅度约为45°','D. 南半球不移动'], 'ans'=>'B', 'expl'=>'北半球夏季北移，冬季南移；南半球夏季（即北半球冬季）南移。统称随直射点移动。'],
            ['type'=>'single', 'q'=>'南亚夏季风（西南季风）的成因是？', 'opt'=>['A. 海陆热力性质差异','B. 气压带风带的季节移动','C. 地形阻挡','D. A和B'], 'ans'=>'D', 'expl'=>'南亚夏季风既受海陆差异影响，也受东南信风越过赤道右偏（气压带移动）影响。'],
            ['type'=>'multi', 'q'=>'【多选】副热带高气压带控制下的区域通常？', 'opt'=>['A. 盛行下沉气流','B. 气候干燥','C. 多沙漠分布','D. 阴雨连绵'], 'ans'=>'ABC', 'expl'=>'高压下沉气流，难以成云致雨，多形成沙漠（如撒哈拉）。'],
            ['type'=>'multi', 'q'=>'【多选】属于低气压带的是？', 'opt'=>['A. 赤道低气压带','B. 副热带高气压带','C. 副极地低气压带','D. 极地高气压带'], 'ans'=>'AC', 'expl'=>'0°和60°附近是低压带。'],
            ['type'=>'multi', 'q'=>'【多选】季风对我国的影响包括？', 'opt'=>['A. 夏季高温多雨，雨热同期','B. 冬季寒冷干燥','C. 带来丰富的水汽','D. 造成旱涝灾害'], 'ans'=>'ABCD', 'expl'=>'季风气候雨热同期利于农业，但季风不稳定也导致旱涝。']
        ],
        'part_b' => [
            ['title'=>'🌍 麦克的旅行', 'q'=>'麦克想去一个终年温和湿润，草地常绿的地方度假。他应该去受哪个风带控制的地区？', 'ans'=>'<b>西风带（中纬度西岸）。</b><br>原因：西风带从海洋带来温暖湿润的气流，全年控制形成温带海洋性气候（如英国），终年温和湿润。'],
            ['title'=>'🚢 郑和下西洋', 'q'=>'郑和下西洋（从中国去印度/非洲）通常选择在冬季出发，夏季返航。为什么？', 'ans'=>'利用<b>季风</b>顺风航行。<br>冬季盛行偏北风（东北季风），船队向南向西行是<b>顺风</b>。夏季盛行偏南风（西南季风），船队回国是<b>顺风</b>。'],
            ['title'=>'🌵 沙漠的成因', 'q'=>'为什么非洲北部的撒哈拉沙漠那么大，而同纬度的我国南方却是“鱼米之乡”？', 'ans'=>'大气环流不同。<br>撒哈拉常年受<b>副热带高压</b>或<b>信风</b>（来自陆地）控制，干旱少雨。而我国南方受<b>季风环流</b>影响，夏季风带来大量海洋水汽，降水丰富。']
        ]
    ]
],
...
'xb1c3s3' => [
    ...
    'ppt' => [
        ...
        ['role'=>'chloe', 'title'=>'气候与景观', 'content'=>'气候决定了地上长什么植物（植被）和土里有什么（土壤）。<br>热带雨林 -> 砖红壤，树木茂密。<br>亚寒带针叶林 -> 灰化土，耐寒松树。<br>如果你看到仙人掌，那一定是热带沙漠气候（副高控制）。', 'visual'=>'icon_forest_map', 'anim_type'=>'fadeIn'],
        ['role'=>'pops', 'title'=>'案例：塞伦盖蒂大迁徙', 'content'=>'东非高原的角马为什么要迁徙？<br>因为那里是<b>热带草原气候</b>。<br>受赤道低压带移动影响，南北半球的干湿季时间相反。<br>动物们为了追逐水草，就跟着赤道低压带（雨带）南北来回跑。<br>这是一场生命的接力！', 'visual'=>'icon_run_direction', 'anim_type'=>'pulse'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'热带雨林气候主要分布在？', 'opt'=>['A. 赤道附近','B. 回归线附近','C. 极圈附近','D. 中纬度内陆'], 'ans'=>'A', 'expl'=>'赤道附近受赤道低压控制，形成热带雨林气候。'],
            ['type'=>'single', 'q'=>'影响非洲塞伦盖蒂动物大迁徙的根本原因是？', 'opt'=>['A. 气温的变化','B. 降水的季节变化','C. 天敌的追捕','D. 人类的驱赶'], 'ans'=>'B', 'expl'=>'热带草原气候干湿季分明，动物追逐降水带来的水草。'],
            ['type'=>'single', 'q'=>'我国著名的水稻产区主要分布在？', 'opt'=>['A. 温带海洋性气候区','B. 地中海气候区','C. 季风气候区','D. 热带沙漠气候区'], 'ans'=>'C', 'expl'=>'季风气候雨热同期，最适宜水稻生长。'],
            ['type'=>'single', 'q'=>'伦敦（英国）的气候类型是？', 'opt'=>['A. 温带海洋性气候','B. 地中海气候','C. 温带大陆性气候','D. 亚寒带针叶林气候'], 'ans'=>'A', 'expl'=>'英国位于欧洲西部，典型温带海洋性气候。'],
            ['type'=>'single', 'q'=>'“雨热同期”是哪种气候类型的显著特征？', 'opt'=>['A. 地中海气候','B. 季风气候','C. 温带海洋性气候','D. 热带沙漠气候'], 'ans'=>'B', 'expl'=>'夏季高温且多雨，是季风气候的优势。'],
            ['type'=>'multi', 'q'=>'【多选】受气压带和风带交替控制形成的气候有？', 'opt'=>['A. 热带草原气候','B. 地中海气候','C. 热带雨林气候','D. 温带海洋性气候'], 'ans'=>'AB', 'expl'=>'C和D是单一系统控制。A是赤道低压+信风，B是副高+西风。'],
            ['type'=>'multi', 'q'=>'【多选】赤道低气压带控制下的自然景观？', 'opt'=>['A. 茂密的森林','B. 各种藤本植物','C. 仙人掌','D. 稀树草原'], 'ans'=>'AB', 'expl'=>'赤道低压形成热带雨林，植被茂密。'],
            ['type'=>'multi', 'q'=>'【多选】气候对人类活动的影响包括？', 'opt'=>['A. 农业种植制度','B. 民居建筑风格','C. 服饰饮食','D. 城市规划'], 'ans'=>'ABCD', 'expl'=>'气候影响衣食住行各个方面。']
        ],
        'part_b' => [
            ...
            ['title'=>'🏡 英国人的伞', 'q'=>'为什么在伦敦街头，人们总是随身带伞？', 'ans'=>'因为是<b>温带海洋性气候</b>。<br>终年受西风带控制，来自大西洋的湿润气流源源不断，导致<b>全年湿润，降水日数多</b>，天气变幻莫测。'],
            ['title'=>'🦓 动物迁徙方向', 'q'=>'7月份，塞伦盖蒂的角马是向北跑还是向南跑？为什么？', 'ans'=>'向<b>北</b>跑。<br>7月是北半球夏季，气压带风带北移。赤道低压带（雨带）移到了北半球的马萨伊马拉（肯尼亚）。为了喝水吃草，角马必须跨过赤道向北迁徙。']
        ]
    ]
],
// --- XB1 4.1 陆地水体及其相互关系 ---
'xb1c4s1' => [
    ...
    'ppt' => [
        ...
        ['role'=>'gidget', 'title'=>'地下水：隐藏的盟友', 'content'=>'我是啾啾。地下水藏在土里。<br>它补给河流最<b>稳定</b>。<br>一般情况：河水高，补给地下水；河水低，地下水补给河流。<br>但在“地上河”（如黄河下游），永远是<b>河水补给地下水</b>（单向），因为河床太高了！', 'visual'=>'icon_soil_layers', 'anim_type'=>'fadeInRight'],
        ['role'=>'chloe', 'title'=>'冰川：固体的水库', 'content'=>'我是克洛伊。冰川是地球上淡水的主力（占2/3）。<br>它们对气候变化超敏感。<br>气温升高，冰川融化，短期内河流径流增加，但长期来看，冰川消退后，河流会面临枯竭的风险。<br>保护冰川就是保护未来的水杯！', 'visual'=>'icon_cold', 'anim_type'=>'fadeIn'],
        ['role'=>'pops', 'title'=>'咸海的悲剧', 'content'=>'我是巴布。咸海曾经是世界第四大湖。<br>但因为人们大量引河水灌溉（种棉花），入湖水量骤减。<br>咸海迅速萎缩，分成了南北两半，盐度升高，鱼类灭绝。<br>这告诉我们：破坏水体平衡，大自然会狠狠报复！', 'visual'=>'icon_drought', 'anim_type'=>'pulse'],
        ['role'=>'max', 'title'=>'相互转化的逻辑', 'content'=>'记住这个原则：<br><b>水位高的补给水位低的。</b><br>水往低处流，这是物理铁律。<br>人类可以通过修建水库、植树造林来调节这种关系，让水资源更听话。', 'visual'=>'icon_integration', 'anim_type'=>'slideInUp'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'黄河下游河水与地下水的补给关系是？', 'opt'=>['A. 互相补给','B. 地下水补给河水','C. 河水补给地下水','D. 无补给关系'], 'ans'=>'C', 'expl'=>'黄河下游是“地上河”，水位高于两岸地下水位，始终是河水补给地下水。'],
            ['type'=>'single', 'q'=>'洞里萨湖对湄公河的主要作用是？', 'opt'=>['A. 发电','B. 通航','C. 调节径流','D. 养殖'], 'ans'=>'C', 'expl'=>'丰水期蓄水，枯水期放水，调节湄公河水量。'],
            ['type'=>'single', 'q'=>'地下水补给河流的特点是？', 'opt'=>['A. 水量大，变化大','B. 水量稳定，变化小','C. 具有明显的季节性','D. 迅猛且短暂'], 'ans'=>'B', 'expl'=>'地下水受外界影响小，补给过程稳定可靠。'],
            ['type'=>'single', 'q'=>'导致咸海面积萎缩的主要人为原因是？', 'opt'=>['A. 气候干旱','B. 蒸发旺盛','C. 大量引水灌溉','D. 围湖造田'], 'ans'=>'C', 'expl'=>'阿姆河和锡尔河流域大量引水种植棉花，导致入湖径流减少。'],
            ['type'=>'single', 'q'=>'“井水不犯河水”在水文地质上通常是？', 'opt'=>['A. 正确的','B. 错误的','C. 视季节而定','D. 只发生在洪水期'], 'ans'=>'B', 'expl'=>'井水（地下水）和河水通常存在互补关系，是相互联系的。'],
            ...
            ['type'=>'multi', 'q'=>'【多选】河流径流的季节变化取决于？', 'opt'=>['A. 补给水源的类型','B. 流域的气候特征','C. 河流的长度','D. 植被覆盖率'], 'ans'=>'ABD', 'expl'=>'河流长度不直接决定季节变化特征。'],
            ['type'=>'multi', 'q'=>'【多选】湖泊消失可能带来的影响？', 'opt'=>['A. 调节气候能力减弱','B. 生物多样性减少','C. 周边土壤盐碱化','D. 下游洪涝灾害加剧'], 'ans'=>'ABCD', 'expl'=>'湖泊具有重要的生态服务功能。']
        ],
        'part_b' => [
            ...
            ['title'=>'❄️ 奇怪的河', 'q'=>'我国东北的河流一年有两个汛期（春汛和夏汛），为什么？', 'ans'=>'<b>补给源不同。</b><br>春汛是因为<b>季节性积雪融化</b>（冬天积的雪春天化了）；夏汛是因为<b>夏季降雨</b>（季风带来降水）。'],
            ['title'=>'🏜️ 塔里木河的断流', 'q'=>'为什么塔里木河越往下游水量越小，甚至会断流？', 'ans'=>'<b>蒸发、下渗和引用。</b><br>流经沙漠地区，蒸发旺盛，沙质土壤下渗严重，加上沿途农业大量引水灌溉，导致下游无水可流。']
        ]
    ]
],
...
'xb1c4s2' => [
    ...
    'ppt' => [
        ...
        ['role'=>'duke', 'title'=>'洋流怎么动？', 'content'=>'我是杜老大。洋流主要靠<b>风</b>吹。<br>1. <b>信风</b>吹动海水向西流（赤道暖流）。<br>2. <b>西风</b>吹动海水向东流（西风漂流）。<br>加上陆地阻挡和地转偏向力，就形成了巨大的<b>环流圈</b>（Gyres）。', 'visual'=>'icon_wind', 'anim_type'=>'slideInLeft'],
        ...
        ['role'=>'duke', 'title'=>'污染与航海', 'content'=>'洋流是把双刃剑。<br><b>污染：</b> 油轮泄漏，洋流会把油污带到远处（扩大污染范围），但也能加快净化速度。<br><b>航海：</b> 哥伦布去美洲走南边（顺加那利寒流+信风），回来走北边（顺西风+北大西洋暖流），这就是利用洋流省油省时的智慧！', 'visual'=>'icon_map_scatter', 'anim_type'=>'fadeIn'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'对西欧温带海洋性气候形成起重要作用的洋流是？', 'opt'=>['A. 北大西洋暖流','B. 北太平洋暖流','C. 加那利寒流','D. 千岛寒流'], 'ans'=>'A', 'expl'=>'北大西洋暖流输送大量热量和水汽，使西欧温和湿润。'],
            ['type'=>'single', 'q'=>'秘鲁渔场形成的主要原因是？', 'opt'=>['A. 寒暖流交汇','B. 长江径流汇入','C. 上升补偿流','D. 人工养殖'], 'ans'=>'C', 'expl'=>'秘鲁沿岸盛行离岸风，深层海水上涌（上升流）带来丰富营养盐。'],
            ['type'=>'single', 'q'=>'南半球的西风漂流性质是？', 'opt'=>['A. 暖流','B. 寒流','C. 季节性洋流','D. 沿岸流'], 'ans'=>'B', 'expl'=>'南半球西风漂流贯穿三大洋，受南极大陆影响大，属于寒流。'],
            ['type'=>'single', 'q'=>'洋流对海洋污染的影响是？', 'opt'=>['A. 缩小污染范围','B. 加快净化速度，扩大污染范围','C. 对污染无影响','D. 集中污染物'], 'ans'=>'B', 'expl'=>'洋流将污染物带走，加快净化，但同时也扩散了污染区域。'],
            ['type'=>'single', 'q'=>'哥伦布两次横渡大西洋，第二次比第一次快很多，是因为？', 'opt'=>['A. 船只动力改进','B. 利用了洋流和风向','C. 路线更短','D. 船员技术提高'], 'ans'=>'B', 'expl'=>'顺着加那利寒流和北赤道暖流，以及东北信风，顺风顺水。'],
            ['type'=>'multi', 'q'=>'【多选】寒流流经的沿岸地区通常？', 'opt'=>['A. 气温较低','B. 降水较少','C. 气温较高','D. 降水丰富'], 'ans'=>'AB', 'expl'=>'寒流具有降温减湿的作用。'],
            ['type'=>'multi', 'q'=>'【多选】世界四大渔场中，由寒暖流交汇形成的是？', 'opt'=>['A. 北海道渔场','B. 北海渔场','C. 纽芬兰渔场','D. 秘鲁渔场'], 'ans'=>'ABC', 'expl'=>'秘鲁渔场是上升流形成的，其他三个是寒暖流交汇。'],
            ['type'=>'multi', 'q'=>'【多选】北印度洋季风洋流的特点？', 'opt'=>['A. 夏季呈顺时针','B. 冬季呈逆时针','C. 全年方向不变','D. 夏冬流向相反'], 'ans'=>'ABD', 'expl'=>'受季风影响，北印度洋洋流夏顺冬逆。']
        ],
        'part_b' => [
            ...
            ['title'=>'🚢 泰坦尼克号的悲剧', 'q'=>'泰坦尼克号是在4月份撞上冰山的。这些冰山是从哪里来的？是谁把它们带到航线上的？', 'ans'=>'来自<b>格陵兰岛/北极地区</b>，是<b>拉布拉多寒流</b>带下来的。<br>拉布拉多寒流挟带北极冰山南下，进入北大西洋暖流所在的航线，造成了撞击风险。']
        ]
    ]
],
...
'xb1c4s3' => [
    ...
    'ppt' => [
        ...
        ['role'=>'duke', 'title'=>'沃克环流：正常模式', 'content'=>'我是杜老大。在赤道太平洋，正常情况是这样的：<br><b>东边（秘鲁）：</b> 冷水（上升流），气压高，干燥。<br><b>西边（印尼）：</b> 暖水，气压低，多雨。<br>空气在赤道上空形成一个圈，叫<b>沃克环流</b>。', 'visual'=>'css_orbit', 'anim_type'=>'rotateIn'],
        ...
        ['role'=>'chloe', 'title'=>'拉尼娜：暴躁的女孩', 'content'=>'我是克洛伊。<b>拉尼娜 (La Niña)</b> 是“圣女”，其实更暴躁。<br><b>起因：</b> 信风太强了！<br><b>后果：</b> 冷水更冷，暖水更暖。<br><b>影响：</b> 正常的状况被<b>极端放大</b>。<br>印尼暴雨成灾，秘鲁干旱加剧。美国发生极寒天气。', 'visual'=>'icon_storm', 'anim_type'=>'slideInUp'],
        ['role'=>'pops', 'title'=>'案例：2017秘鲁洪水', 'content'=>'2017年，秘鲁出现罕见暴雨，沙漠变汪洋。<br>原因就是<b>沿岸海水异常升温</b>（类厄尔尼诺现象）。<br>海水热 -> 蒸发快 -> 空气上升 -> 暴雨。<br>这直接证明了海洋对大气的主导作用。', 'visual'=>'icon_flood_safe', 'anim_type'=>'pulse'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'海洋向大气输送热量的主要方式是？', 'opt'=>['A. 潜热输送（蒸发）','B. 短波辐射','C. 传导','D. 对流'], 'ans'=>'A', 'expl'=>'海水蒸发吸收热量（潜热），水汽凝结时释放给大气，这是主要的输热方式。'],
            ...
            ['type'=>'single', 'q'=>'拉尼娜现象发生时，赤道太平洋西部（如印度尼西亚）通常会？', 'opt'=>['A. 发生旱灾','B. 降水增多，甚至洪涝','C. 气温降低','D. 森林火灾频发'], 'ans'=>'B', 'expl'=>'拉尼娜加强了沃克环流，西太平洋上升气流更强，降水更多。'],
            ['type'=>'single', 'q'=>'维持全球水热平衡的主要途径是？', 'opt'=>['A. 地壳运动','B. 岩石圈物质循环','C. 大气环流与大洋环流','D. 生物循环'], 'ans'=>'C', 'expl'=>'大气环流和大洋环流促进了高低纬度间、海陆间的热量和水分传输。'],
            ['type'=>'single', 'q'=>'正常年份，赤道太平洋海域的水温分布特点是？', 'opt'=>['A. 西高东低','B. 东高西低','C. 中间高两边低','D. 均匀分布'], 'ans'=>'A', 'expl'=>'受信风和洋流影响，暖水堆积在西部，东部有冷水上泛，所以西暖东冷。'],
            ['type'=>'single', 'q'=>'海—气相互作用最活跃的区域通常在？', 'opt'=>['A. 极地高压带','B. 赤道地区（低纬度海区）','C. 寒流流经区','D. 深海区'], 'ans'=>'B', 'expl'=>'低纬度海区太阳辐射强，蒸发旺盛，热量交换最活跃。'],
            ['type'=>'multi', 'q'=>'【多选】厄尔尼诺现象对全球气候可能产生的影响？', 'opt'=>['A. 秘鲁沿岸暴雨','B. 澳大利亚干旱','C. 全球各地降水均匀','D. 我国出现暖冬'], 'ans'=>'ABD', 'expl'=>'厄尔尼诺是全球性的气候异常，会导致多地气候反常，不会使降水均匀。'],
            ['type'=>'multi', 'q'=>'【多选】海洋对大气的作用主要表现在？', 'opt'=>['A. 提供水汽','B. 储存热量','C. 吸收二氧化碳','D. 驱动板块运动'], 'ans'=>'ABC', 'expl'=>'D是地球内力作用。'],
            ['type'=>'multi', 'q'=>'【多选】判断厄尔尼诺现象的主要依据？', 'opt'=>['A. 赤道东太平洋海温异常升高','B. 东南信风减弱','C. 秘鲁渔场减产','D. 北极冰川融化'], 'ans'=>'ABC', 'expl'=>'D与厄尔尼诺无直接定义关系。']
        ],
        'part_b' => [
            ['title'=>'🎣 渔民的眼泪', 'q'=>'为什么厄尔尼诺发生时，秘鲁的渔民会很伤心？', 'ans'=>'<b>鱼饿死或跑了。</b><br>厄尔尼诺导致冷海水上泛（上升流）减弱或消失，表层海水营养物质减少，浮游生物饿死，鱼类因缺乏食物而大量死亡或迁徙，导致渔业崩溃。'],
            ['title'=>'🔥 澳洲大火', 'q'=>'为什么厄尔尼诺年份，澳大利亚容易发生森林大火？', 'ans'=>'<b>下沉气流导致干旱。</b><br>厄尔尼诺时，暖水东移，西太平洋（澳大利亚附近）水温相对降低，气流由上升转为下沉，降水减少，气候干燥，容易引发山火。'],
            ['title'=>'🌪️ 台风去哪了', 'q'=>'厄尔尼诺年份，登陆我国的台风通常会变少，为什么？', 'ans'=>'<b>生成位置偏东。</b><br>厄尔尼诺导致西太平洋暖水向东移动，台风生成源地也随之向东偏（离我国更远），在长途跋涉中容易夭折或转向，所以登陆我国的数量往往偏少（但强度可能不减）。']
        ]
    ]
],
// --- XB1 5.1 自然环境的整体性 ---
'xb1c5s1' => [
    ...
    'ppt' => [
        ...
        ['role'=>'snowball', 'title'=>'要素间的交换', 'content'=>'我是小白！看它们怎么互动的：<br>1. <b>水循环</b>：把水圈、大气圈、生物圈连起来。<br>2. <b>生物循环</b>：植物光合作用吸收大气中的CO2，从土里吸水和无机盐，合成有机物。<br>没有这些循环，地球就是死球一个！', 'visual'=>'icon_recycle', 'anim_type'=>'rotateIn'],
        ['role'=>'duke', 'title'=>'整体性的功能', 'content'=>'我是杜老大。大家庭合起来有两个超能力：<br>1. <b>生产功能</b>：合成有机物（光合作用）。单独的土或水都做不到，必须合体！<br>2. <b>稳定功能</b>：自我调节。比如大气中CO2多了，植物就多吸点，海里也多溶点，努力维持平衡。', 'visual'=>'icon_life', 'anim_type'=>'slideInUp'],
        ...
        ['role'=>'pops', 'title'=>'演化：沧海桑田', 'content'=>'我是巴布。环境是会变的。<br>比如<b>湖泊演变为陆地</b>的过程：<br>深水湖 -> 泥沙淤积变浅 -> 长出水草（沼泽） -> 长出灌木（草甸） -> 最后变成森林。<br>这期间，气候变干，鱼类消失，土壤变厚。所有要素是一起变的！', 'visual'=>'icon_forest_map', 'anim_type'=>'pulse'],
        ...
        ['role'=>'duke', 'title'=>'特工行动：修补', 'content'=>'既然破坏有连锁反应，修复也有！<br>我们在黄土高原<b>植树种草</b>：<br>-> 根系固土（土壤改善）<br>-> 涵养水源（水文改善）<br>-> 空气湿润（气候改善）。<br>利用整体性原理，我们可以修复地球！', 'visual'=>'icon_protect_soil', 'anim_type'=>'zoomIn'],
    ...
    'quiz' => [
        'part_a' => [
            ['type'=>'single', 'q'=>'自然地理环境的五大要素是？', 'opt'=>['A. 大气、水、岩石、生物、土壤','B. 大气、水、阳光、温度、土壤','C. 森林、河流、高山、平原、沙漠','D. 动物、植物、微生物、空气、水'], 'ans'=>'A', 'expl'=>'自然环境由大气、水、土壤、生物、岩石（地貌）五大要素组成。'],
            ['type'=>'single', 'q'=>'“牵一发而动全身”体现了自然环境的？', 'opt'=>['A. 差异性','B. 整体性','C. 稳定性','D. 复杂性'], 'ans'=>'B', 'expl'=>'某一要素变化会导致其他要素甚至整体发生变化，是整体性的体现。'],
            ['type'=>'single', 'q'=>'黄土高原水土流失的根本原因是破坏了哪个要素？', 'opt'=>['A. 地貌','B. 植被（生物）','C. 气候','D. 土壤'], 'ans'=>'B', 'expl'=>'植被破坏是导致水土流失加剧的诱因，进而引发一系列变化。'],
            ['type'=>'single', 'q'=>'光合作用体现了自然环境的什么功能？', 'opt'=>['A. 稳定功能','B. 生产功能','C. 调节功能','D. 降解功能'], 'ans'=>'B', 'expl'=>'生产功能是指自然环境合成有机物的能力，主要依赖光合作用。'],
            ['type'=>'single', 'q'=>'在湖泊演变为陆地的过程中，最后出现的植被通常是？', 'opt'=>['A. 水生植物','B. 湿生植被','C. 草甸','D. 森林'], 'ans'=>'D', 'expl'=>'演化过程通常为：深水湖->浅水湖->沼泽->草甸->森林。'],
            ['type'=>'single', 'q'=>'我国西北内陆地区气候干旱，导致植被稀少，河流短小。这说明？', 'opt'=>['A. 各要素相互独立','B. 气候要素起主导作用','C. 要素间相互制约','D. 水文决定了气候'], 'ans'=>'C', 'expl'=>'气候干旱制约了植被和水文，体现了要素间的统一性和相互制约。'],
            ['type'=>'single', 'q'=>'下列现象不能体现自然环境整体性的是？', 'opt'=>['A. 雨林破坏导致全球变暖','B. 青藏高原隆起改变亚洲气候','C. 围湖造田加剧洪涝灾害','D. 两个独立地区的温度不同'], 'ans'=>'D', 'expl'=>'D是差异性的表现，不是要素间相互作用的整体性。'],
            ['type'=>'multi', 'q'=>'【多选】黄山“四绝”的形成体现了？', 'opt'=>['A. 自然环境的整体性','B. 各要素的独立发展','C. 要素间的统一演化','D. 人类活动的主导作用'], 'ans'=>'AC', 'expl'=>'花岗岩、气候、植被等要素协同演化形成了景观组合。'],
            ['type'=>'multi', 'q'=>'【多选】森林面积锐减可能导致的后果？', 'opt'=>['A. 生物多样性减少','B. 大气中二氧化碳增加','C. 洪水风险增加','D. 土壤肥力下降'], 'ans'=>'ABCD', 'expl'=>'森林破坏会引发“多米诺骨牌”式的连锁反应。'],
            ['type'=>'multi', 'q'=>'【多选】自然环境的稳定功能主要依赖于？', 'opt'=>['A. 物质的单向流动','B. 系统的自我调节能力','C. 能量的持续输入','D. 各要素的负反馈机制'], 'ans'=>'BD', 'expl'=>'自我调节和负反馈（如捕食关系、碳氧平衡）维持了环境稳定。']
        ],
        'part_b' => [
            ...
            ['title'=>'🏞️ 黄土高原的救赎', 'q'=>'如果不治理黄土高原的水土流失，黄河下游会发生什么变化？', 'ans'=>'<b>河床抬升，洪涝加剧。</b><br>水土流失导致大量泥沙进入黄河。到了下游平原，流速减慢，泥沙淤积，河床不断抬高形成“地上河”。一旦暴雨，极易决堤泛滥。'],
            ['title'=>'🌲 森林归来', 'q'=>'在湖泊演变成森林的过程中，土壤发生了什么变化？', 'ans'=>'<b>变厚、变肥沃。</b><br>随着生物从水生变为陆生（草、树），植物根系越来越发达，枯枝落叶层增加，微生物分解活跃，土壤有机质积累，土层逐渐变厚，透气性变好。']
        ]
    ]
],
...
'xb1c5s2' => [
    ...
    'ppt' => [
        ...
        ['role'=>'chloe', 'title'=>'案例：喜马拉雅的南北', 'content'=>'我是克洛伊。看看喜马拉雅山（P88）。<br><b>南坡：</b> 迎风坡（水多），阳坡（热），基带是热带雨林，带谱非常完整。<br><b>北坡：</b> 背风坡（干），阴坡（冷），基带是青藏高原，带谱简单。<br>雪线也是南坡低（因为降雪多），北坡高。', 'visual'=>'icon_compare', 'anim_type'=>'fadeIn'],
        ['role'=>'pops', 'title'=>'案例：天山的“腰带”', 'content'=>'我是巴布。天山很特别。<br>在干旱的新疆，天山半山腰（北坡）却有一片<b>云杉林</b>。<br>为什么？因为来自大西洋和北冰洋的水汽，在半山腰受地形抬升形成降水。<br>上面是草甸，下面是草原，中间夹着森林，像条腰带。', 'visual'=>'icon_forest_map', 'anim_type'=>'pulse'],
        ['role'=>'snowball', 'title'=>'地方性分异：不走寻常路', 'content'=>'有些地方不按套路出牌，叫<b>非地带性</b>。<br>1. <b>沙漠里的绿洲</b>：因为有地下水。<br>2. <b>南半球缺失针叶林</b>：因为那个纬度全是海洋，没陆地。<br>3. <b>河谷里的树</b>：温带草原沟谷里有树，因为那里水多。<br>这是局部小环境造成的。', 'visual'=>'icon_soil_layers', 'anim_type'=>'shake'],
    ...
    'quiz' => [
        'part_a' => [
            ...
            ['type'=>'single', 'q'=>'下列山脉中，垂直带谱最复杂的是？', 'opt'=>['A. 长白山（温带）','B. 泰山（暖温带）','C. 乞力马扎罗山（赤道）','D. 阿尔卑斯山（温带）'], 'ans'=>'C', 'expl'=>'纬度越低、海拔越高，垂直自然带谱越复杂。乞力马扎罗山位于赤道且海拔高。'],
            ['type'=>'single', 'q'=>'喜马拉雅山南坡雪线比北坡低，主要原因是？', 'opt'=>['A. 南坡是向阳坡','B. 南坡是迎风坡，降雪多','C. 南坡坡度缓','D. 南坡人类活动多'], 'ans'=>'B', 'expl'=>'雪线高度受气温和降水影响。南坡虽是阳坡（气温高应雪线高），但更是迎风坡（降雪量极大），降水因素占主导，导致雪线低。'],
            ['type'=>'single', 'q'=>'南半球缺失亚寒带针叶林带，主要原因是？', 'opt'=>['A. 地形阻挡','B. 海陆分布（该纬度海洋为主）','C. 洋流影响','D. 气候变暖'], 'ans'=>'B', 'expl'=>'南纬50°-60°几乎全部是海洋，缺乏陆地，这是非地带性现象。'],
            ['type'=>'single', 'q'=>'天山北坡半山腰出现森林带（云杉林），主要受什么因素影响？', 'opt'=>['A. 热量','B. 地形雨（水分）','C. 土壤肥力','D. 光照'], 'ans'=>'B', 'expl'=>'准噶尔盆地的水汽在天山北坡抬升，在半山腰形成地形雨，满足森林生长。'],
            ['type'=>'single', 'q'=>'沙漠中出现的绿洲属于？', 'opt'=>['A. 纬度地带性','B. 经度地带性','C. 垂直地带性','D. 地方性分异（非地带性）'], 'ans'=>'D', 'expl'=>'局部地下水丰富导致荒漠中出现绿洲，属地方性分异。'],
            ['type'=>'multi', 'q'=>'【多选】影响山地垂直自然带谱复杂程度的因素有？', 'opt'=>['A. 山脉所在的纬度','B. 山脉的海拔高度','C. 山脉的相对高度','D. 山脉的走向'], 'ans'=>'ABC', 'expl'=>'纬度越低、海拔越高、相对高度越大，带谱越复杂。'],
            ['type'=>'multi', 'q'=>'【多选】从沿海向内陆的地域分异规律，在哪些地区表现最明显？', 'opt'=>['A. 低纬度','B. 中纬度','C. 高纬度','D. 北半球'], 'ans'=>'BD', 'expl'=>'北半球中纬度陆地宽广，海陆差异显著，经度地带性最典型。'],
            ['type'=>'multi', 'q'=>'【多选】下列现象属于地方性分异的是？', 'opt'=>['A. 华北平原的落叶阔叶林','B. 四川盆地的紫色土','C. 尼罗河谷的绿色走廊','D. 海南岛的热带雨林'], 'ans'=>'BC', 'expl'=>'A和D是地带性规律；B（岩性）和C（水源）是地方性分异。']
        ],
        'part_b' => [
            ...
            ['title'=>'🌲 天山的怪事', 'q'=>'在天山，为什么森林只长在北坡，南坡却是光秃秃的草原或荒漠？（提示：水）', 'ans'=>'<b>北坡水分条件好。</b><br>天山北坡是迎风坡（接纳来自大西洋和北冰洋的水汽），降水较多，且北坡是阴坡，蒸发较弱，水分能维持森林生长。南坡是背风坡且向阳，蒸发强，太干旱，长不出树。'],
            ['title'=>'🌵 东西的差异', 'q'=>'坐火车从连云港到乌鲁木齐，窗外的风景是怎么变的？为什么？', 'ans'=>'<b>森林 -> 草原 -> 荒漠。</b><br>这是<b>经度地带性</b>。离海越来越远，来自太平洋的水汽越来越少，水分条件逐渐变差，植被也随之变化。']
        ]
    ]
],
...
'xb2c1s1' => [
    'title' => '1.1 多种多样的区域',
    'ppt' => [
        ['role'=>'peter', 'title'=>'欢迎来到区域花园！', 'content'=>'嘿！我是<b>彼得兔</b>。欢迎来到“地理大花园”（选择性必修2）。<br>我们的世界就像这个大花园，被划分成了一块块不同的地盘，我们管它叫<b>“区域”</b>。<br>麦奎格先生的菜园是一个区域，远处的森林又是另一个区域。<br>今天，我们就来探险，看看这些区域到底有什么名堂！', 'visual'=>'icon_map_scatter', 'anim_type'=>'fadeIn'],
        ['role'=>'lily', 'title'=>'什么是区域？', 'content'=>'我是<b>莉莉</b>。区域可不是随便画的。<br>它是人们在地球表面按照一定的<b>目的和标准</b>划定的空间单元。<br><b>特点：</b><br>1. <b>客观性</b>：地表是真实存在的。<br>2. <b>主观性</b>：怎么划是人决定的（比如按气候划，还是按行政管辖划）。', 'visual'=>'icon_chart', 'anim_type'=>'slideInLeft'],
        ...
        ['role'=>'peter', 'title'=>'发展条件的差异', 'content'=>'每一块区域的“性格”都不一样。<br>有的适合种胡萝卜（平原、水足），有的适合躲猫猫（山区、林密）。<br><b>因地制宜</b>就是：在合适的地方做合适的事。<br>比如教材提到的<b>平沙岛</b>，因为是江心岛，适合搞农业和旅游，不适合建大工厂。', 'visual'=>'icon_climate_soil', 'anim_type'=>'pulse'],
        ...
        ['role'=>'lily', 'title'=>'区域的划分指标', 'content'=>'我们要怎么划定区域呢？<br>1. <b>单一指标</b>：只看一样东西（如降水量 -> 干湿区）。<br>2. <b>综合指标</b>：看好多样东西（如语言、宗教、历史 -> 文化区）。<br>只要标准不同，划出来的区域就不一样哦！', 'visual'=>'icon_chart', 'anim_type'=>'fadeIn'],
        ['role'=>'benjamin', 'title'=>'区域的区位特征', 'content'=>'每个区域都有它独特的位置。<br>比如广东在沿海（利于贸易），新疆在内陆（利于边贸）。<br>位置决定了你能和谁做朋友（关联性），也决定了你的发展潜力。<br>所以，选地盘很重要！', 'visual'=>'icon_map_scatter', 'anim_type'=>'rotateIn'],
        ['role'=>'tod', 'title'=>'不同尺度的影响', 'content'=>'不同大小的区域，作用不一样。<br>大尺度的区域（如长三角）决定大方向。<br>小尺度的区域（如某个产业园）决定具体细节。<br>它们相互促进，就像大树和小草一样。', 'visual'=>'icon_tree', 'anim_type'=>'shake'],
...
'xb2c1s2' => [
    ...
    'ppt' => [
        ...
        ['role'=>'lily', 'title'=>'区域的发展', 'content'=>'区域发展不是一成不变的。<br>从初期到成熟，关联性会越来越强。<br>比如青田县，以前只是自己养鱼吃，现在通过网络把鱼干卖到了全世界（关联性增强），这就是发展！', 'visual'=>'icon_phone', 'anim_type'=>'fadeIn'],
        ['role'=>'peter', 'title'=>'东西部协作', 'content'=>'我国的东部和西部也在搞“关联”。<br>东部（有钱有技术）帮助西部（有资源有劳动力）。<br>这叫<b>优势互补</b>。<br>就像我和本杰明合作，他力气大（西部），我跑得快（东部），我们一起去偷……哦不，去采萝卜！', 'visual'=>'icon_integration', 'anim_type'=>'shake'],
        ['role'=>'jemima', 'title'=>'不平衡是动力', 'content'=>'区域之间如果不平衡，就会产生流动。<br>水往低处流（自然），人往高处走（经济）。<br>正是这种不平衡，推动了要素的流动，最后促进了共同发展。', 'visual'=>'icon_run_direction', 'anim_type'=>'slideInRight'],
...
// === XB3 第一章 自然环境与人类社会 ===
    ...
    'xb3c1s1' => [
        'title' => '1.1 自然环境的服务功能',
        'ppt' => [
            ['role'=>'mufasa', 'title'=>'国王的教诲：万物之理', 'content'=>'辛巴，你看阳光所照耀的地方。大自然不仅仅是风景，它为我们提供了一切。<br>这就是<b>自然环境的服务功能</b>。<br>它是人类生存和发展的根基。如果破坏了它，荣耀国就会变成荒芜的象墓地。', 'visual'=>'icon_sun_mountain', 'anim_type'=>'fadeIn'],
            ['role'=>'rafiki', 'title'=>'拉飞奇课堂：四种魔法', 'content'=>'呵呵呵！自然界的魔法分四种（P3）：<br>1. <b>供给服务</b>：给吃的用的（水、木材、药草）。<br>2. <b>调节服务</b>：调节气候（森林降温）、净化水质。<br>3. <b>文化服务</b>：让你觉得美，心情好（旅游、灵感）。<br>4. <b>支撑服务</b>：这是最基础的！土壤形成、光合作用、养分循环。没有它，前三种都没戏！', 'visual'=>'icon_tree', 'anim_type'=>'rotateIn'],
            ['role'=>'timon', 'title'=>'一棵树的账单', 'content'=>'我是丁满。听说一棵树很值钱？（P2）<br>人民日报算了笔账：<br>产氧气值3万美元，涵养水源值3.7万美元。<br>还有栖息地价值。<br><b>结论：</b> 活着的树比砍下来的木头贵多了！', 'visual'=>'icon_money', 'anim_type'=>'slideInLeft'],
            ['role'=>'scar', 'title'=>'刀疤的阴谋：大坝', 'content'=>'哼，我要修个大坝！<br>好处是有的：能发电（供给），能防洪（调节）。<br>但坏处也不少（P4）：<br>淹没森林（破坏支撑），阻断鱼洄游，下游泥沙也没了。<br>只要我能掌权，管它什么副作用！', 'visual'=>'icon_dam', 'anim_type'=>'shake'],
            ['role'=>'mufasa', 'title'=>'可持续利用', 'content'=>'辛巴，这就是为什么我们要<b>可持续利用</b>。<br>1. 索取不能超过<b>供给极限</b>。<br>2. 排放不能超过<b>调节极限</b>。<br>3. 绝不能损害<b>支撑服务</b>（那是底线）。<br>我们是在吃大自然的利息，不能把本金（自然资本）吃光了！', 'visual'=>'icon_balance', 'anim_type'=>'zoomIn'],
            ['role'=>'simba', 'title'=>'全节总结', 'content'=>'我明白了父亲！<br>自然有供给、调节、文化、支撑四大功能。<br>我们必须在环境允许的范围内发展。<br>守护荣耀国，就是守护这些功能！', 'visual'=>'icon_shield', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'森林不仅提供木材，还能调节气候、涵养水源。这分别体现了自然环境的？', 'opt'=>['A. 供给服务、调节服务','B. 供给服务、文化服务','C. 支撑服务、调节服务','D. 调节服务、供给服务'], 'ans'=>'A', 'expl'=>'提供实物是供给，改善环境条件是调节。'],
                ['type'=>'single', 'q'=>'在四种服务功能中，被视为其他服务基础和前提的是？', 'opt'=>['A. 供给服务','B. 调节服务','C. 文化服务','D. 支撑服务'], 'ans'=>'D', 'expl'=>'支撑服务（如土壤形成、光合作用）维持环境自身的稳定，是基础。'],
                ['type'=>'single', 'q'=>'“落红不是无情物，化作春泥更护花”描述的是自然环境的？', 'opt'=>['A. 供给服务','B. 支撑服务（养分循环）','C. 调节服务','D. 文化服务'], 'ans'=>'B', 'expl'=>'物质循环和养分归还是支撑服务的一部分。'],
                ['type'=>'single', 'q'=>'如果把自然环境比作银行，人类可持续利用应该？', 'opt'=>['A. 只花利息，不动本金','B. 连本带利一起花','C. 借贷消费','D. 拒绝使用任何资金'], 'ans'=>'A', 'expl'=>'自然资本（本金）要保留，利用其再生部分（利息）。'],
                ['type'=>'multi', 'q'=>'【多选】修建水坝可能对自然环境服务功能产生的影响？', 'opt'=>['A. 增强防洪抗旱能力（调节服务）','B. 提供水电（供给服务）','C. 阻断鱼类洄游（损害支撑服务）','D. 淹没库区土地（损害供给/支撑服务）'], 'ans'=>'ABCD', 'expl'=>'水坝工程往往利弊共存，需综合权衡。']
            ],
            'part_b' => [
                ['title'=>'🦁 辛巴的决策', 'q'=>'荣耀国爆发了虫灾，刀疤建议用强力杀虫剂DDT把虫子全杀光。你会采纳吗？为什么？', 'ans'=>'<b>不采纳。</b><br>虽然DDT能短期消除虫灾（人为调节），但它会残留并富集在食物链中，毒死吃虫的鸟类和其他动物，破坏生态系统的<b>支撑服务</b>（生物多样性）。最终会毁了整个草原。'],
                ['title'=>'🌳 树的价值', 'q'=>'为什么说“如果没有森林，人类将无法生存1年”？', 'ans'=>'因为森林提供<b>氧气</b>（供给/调节）和<b>涵养水源</b>（调节）。<br>更重要的是，森林维持着生物圈的碳氧平衡和水循环（支撑服务）。如果支撑服务崩溃，整个生命支持系统就会瓦解。']
            ]
        ]
    ],
    ...
    'xb3c1s2' => [
        'title' => '1.2 自然资源及其利用',
        'ppt' => [
            ['role'=>'simba', 'title'=>'荣耀国的宝藏', 'content'=>'我是辛巴。这片土地有丰富的资源。<br><b>自然资源</b>：自然界中能满足我们需求的物质和能量。<br>比如水、土、矿、生物。<br>分为：<b>可再生</b>（像草，吃完还能长）和<b>非可再生</b>（像石头，用一块少一块）。', 'visual'=>'icon_rock_plant', 'anim_type'=>'fadeIn'],
            ['role'=>'rafiki', 'title'=>'属性：自然与社会', 'content'=>'资源有两个属性（P6）：<br>1. <b>自然属性</b>：它在哪、有多少，是老天定的（客观）。<br>2. <b>社会属性</b>：怎么用、有没有用，是人定的。<br>比如石油，以前只能拿来点灯（沈括《梦溪笔谈》），现在能做衣服、开汽车！', 'visual'=>'icon_oil', 'anim_type'=>'rotateIn'],
            ['role'=>'scar', 'title'=>'稀缺与危机', 'content'=>'资源是有限的！<br><b>非可再生资源</b>：总量固定。<br><b>可再生资源</b>：补给有限。<br>如果你们这就么吃下去，迟早有一天会<b>“稀缺”</b>。<br>稀缺了会怎样？价格上涨，引发争夺！', 'visual'=>'icon_alert_red', 'anim_type'=>'shake'],
            ['role'=>'timon', 'title'=>'质量有高低', 'content'=>'我是丁满。虫子也有肥瘦之分！<br><b>质量特征</b>：<br>铁矿看“品位”（含铁量）。<br>石油看“含硫量”（硫越少越好）。<br>耕地看“肥力”。<br>质量不同，开发成本就不一样。我们当然喜欢吃肥虫子！', 'visual'=>'icon_chart', 'anim_type'=>'slideInUp'],
            ['role'=>'pumbaa', 'title'=>'分布不均匀', 'content'=>'我是彭彭。有些地方水多，有些地方矿多。<br>比如中国：<b>北方多煤，南方多磷；北方地多水少，南方水多地少。</b><br>这叫<b>空间分布不均</b>。<br>所以我们需要“南水北调”、“西气东输”！', 'visual'=>'icon_map_scatter', 'anim_type'=>'zoomIn'],
            ['role'=>'mufasa', 'title'=>'代际公平', 'content'=>'辛巴，我们不能把羚羊都吃光。<br>我们要给后代留下资源。<br>对于不可再生资源，要节约，找替代品。<br>对于可再生资源，利用速度不能超过<b>再生速度</b>。<br>这就是王者的责任。', 'visual'=>'icon_baby', 'anim_type'=>'fadeIn'],
            ['role'=>'simba', 'title'=>'全节总结', 'content'=>'资源分两类，属性有双重。<br>数量有限制，质量有不同。<br>分布不均匀，调配显神通。<br>节约可持续，万代乐无穷！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'下列属于非可再生资源的是？', 'opt'=>['A. 森林','B. 土地','C. 铁矿','D. 太阳能'], 'ans'=>'C', 'expl'=>'矿产资源形成周期极长，属于非可再生。'],
                ['type'=>'single', 'q'=>'北宋沈括用石油制墨，现代用石油炼油，这说明自然资源具有？', 'opt'=>['A. 整体性','B. 地域性','C. 社会属性','D. 不可再生性'], 'ans'=>'C', 'expl'=>'利用方式和价值随社会发展而变化，是社会属性。'],
                ['type'=>'single', 'q'=>'资源的“稀缺性”是指？', 'opt'=>['A. 资源绝对数量很少','B. 资源分布太分散','C. 相对于人类无限的需求，资源供给是有限的','D. 资源无法再生'], 'ans'=>'C', 'expl'=>'稀缺是相对概念，需求>供给。'],
                ['type'=>'single', 'q'=>'我国“南水北调”工程是为了解决水资源的？', 'opt'=>['A. 时间分配不均','B. 空间分布不均','C. 质量差异大','D. 浪费严重'], 'ans'=>'B', 'expl'=>'解决北方缺水、南方水多的空间差异。'],
                ['type'=>'single', 'q'=>'提铁降硅技术提高了铁矿石的利用率，这说明？', 'opt'=>['A. 技术能增加资源总量','B. 技术能挖掘资源潜力，降低质量限制','C. 资源质量不再重要','D. 资源可以无限开发'], 'ans'=>'B', 'expl'=>'技术进步使原本不可用或难用的低品位矿变得可用。'],
                ['type'=>'multi', 'q'=>'【多选】面对资源短缺，合理的对策是？', 'opt'=>['A. 提高利用率','B. 寻找替代资源','C. 跨区域调配','D. 停止开发'], 'ans'=>'ABC', 'expl'=>'停止开发不符合发展需求。'],
                ['type'=>'multi', 'q'=>'【多选】可再生资源的利用原则？', 'opt'=>['A. 可以无限制利用','B. 利用速度不超过更新速度','C. 保护其再生环境','D. 只能在雨季利用'], 'ans'=>'BC', 'expl'=>'可再生资源也有极限。']
            ],
            'part_b' => [
                ['title'=>'🥛 牛奶背后的资源', 'q'=>'彭彭喝了一杯牛奶，他消耗了哪些自然资源？', 'ans'=>'<b>不仅是草。</b><br>1. <b>土地/水/光</b>（长牧草）。<br>2. <b>矿产/能源</b>（加工、运输、冷藏牛奶需要电和油）。<br>现代工业化生产延长了产业链，消耗的资源远比直接吃草多。'],
                ['title'=>'💎 狗头金的故事', 'q'=>'为什么以前人们只捡“狗头金”（高品位金矿），现在连含金量很低的石头也开采？', 'ans'=>'1. <b>技术进步</b>：提炼技术提高了，低品位矿也能赚钱。<br>2. <b>资源稀缺</b>：高品位矿挖完了，只能挖低品位的。<br>3. <b>价格上涨</b>：金价高，覆盖了高昂的开采成本。']
            ]
        ]
    ],
    ...
    'xb3c1s3' => [
        'title' => '1.3 环境问题及其危害',
        'ppt' => [
            ['role'=>'scar', 'title'=>'刀疤的杰作：环境问题', 'content'=>'看这片荒地！<br><b>环境问题</b>怎么来的？<br>1. <b>输入端</b>：我要太多资源（过度开发）。<br>2. <b>输出端</b>：我扔太多垃圾（过度排放）。<br>当人类的索取和排放超过了自然的<b>恢复能力</b>和<b>净化能力</b>，问题就来了！', 'visual'=>'icon_earth_crack', 'anim_type'=>'fadeIn'],
            ['role'=>'rafiki', 'title'=>'环境问题的表现', 'content'=>'哎，地球病了。<br><b>大气污染</b>：雾霾、酸雨。<br><b>水体污染</b>：日本琵琶湖的赤潮（P15）。<br><b>生态退化</b>：森林减少、水土流失。<br><b>全球变暖</b>：温室气体太多。<br>这都是失衡的表现。', 'visual'=>'icon_storm', 'anim_type'=>'slideInLeft'],
            ['role'=>'timon', 'title'=>'DDT的教训', 'content'=>'我是丁满。以前我们用DDT杀虫，觉得很棒。<br>后来发现，DDT在<b>食物链</b>里富集。<br>草 -> 虫 -> 鸟 -> 鹰。<br>鹰体内的DDT浓度是草的百万倍！鹰蛋壳变薄，孵不出小鹰。<br>这就是《寂静的春天》里写的悲剧。', 'visual'=>'icon_alert_yellow', 'anim_type'=>'rotateIn'],
            ['role'=>'pumbaa', 'title'=>'环境库兹涅茨曲线', 'content'=>'我是彭彭。有个叫库兹涅茨的人画了条线（P16）。<br>呈<b>倒U型</b>。<br>经济刚发展时，环境变坏（先污染）。<br>经济发展到一定程度（拐点），有钱治污了，环境变好（后治理）。<br>我们要争取早点到达拐点，或者不走弯路！', 'visual'=>'css_curve', 'anim_type'=>'zoomIn'],
            ['role'=>'mufasa', 'title'=>'对国家安全的威胁', 'content'=>'环境问题不仅是难看，更是危险。<br>1. <b>生命安全</b>：雾霾致病，水污染中毒。<br>2. <b>经济安全</b>：治理污染花巨资，资源枯竭断财路。<br>3. <b>社会稳定</b>：因为抢水打架，因为污染游行。<br>所以，生态安全是国家安全的重要组成部分！', 'visual'=>'icon_shield', 'anim_type'=>'pulse'],
            ['role'=>'simba', 'title'=>'突发事件的冲击', 'content'=>'还有那些突然发生的噩梦：<br>切尔诺贝利核事故、海上溢油。<br>它们破坏力极强，瞬间摧毁一切。<br>我们要建立预警机制，防患于未然。', 'visual'=>'icon_alert_red', 'anim_type'=>'shake'],
            ['role'=>'simba', 'title'=>'全节总结', 'content'=>'索取排放超限度，<br>环境危机由此出。<br>污染生态两头堵，<br>安全底线要守住。<br>莫待春天变寂静，<br>绿色发展是正路！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'环境问题产生的机制是？', 'opt'=>['A. 自然系统的自我演化','B. 人类系统对环境的索取和排放超过了其限度','C. 科技发展的必然结果','D. 所有的自然灾害'], 'ans'=>'B', 'expl'=>'输入>再生，输出>自净。'],
                ['type'=>'single', 'q'=>'DDT被禁用是因为它具有？', 'opt'=>['A. 挥发性','B. 生物富集性','C. 腐蚀性','D. 易燃性'], 'ans'=>'B', 'expl'=>'通过食物链逐级放大毒性。'],
                ['type'=>'single', 'q'=>'环境库兹涅茨曲线表明，经济发展与环境质量的关系通常是？', 'opt'=>['A. 直线正相关','B. 直线负相关','C. 倒U型曲线（先恶化后改善）','D. U型曲线（先改善后恶化）'], 'ans'=>'C', 'expl'=>'先污染后治理的传统模式。'],
                ['type'=>'single', 'q'=>'日本琵琶湖治理耗时30多年，说明环境问题具有？', 'opt'=>['A. 易治理性','B. 长期性和艰巨性','C. 突发性','D. 不可逆性'], 'ans'=>'B', 'expl'=>'一旦破坏，恢复极难。'],
                ['type'=>'single', 'q'=>'I = P × A × T 公式中，P代表？', 'opt'=>['A. 污染物','B. 人口数量','C. 消费水平','D. 技术'], 'ans'=>'B', 'expl'=>'Population（人口）。'],
                ['type'=>'single', 'q'=>'《寂静的春天》一书唤醒了人类的？', 'opt'=>['A. 战争意识','B. 环保意识','C. 登月梦想','D. 淘金热'], 'ans'=>'B', 'expl'=>'蕾切尔·卡森揭示了农药的危害，开启了现代环保运动。'],
                ['type'=>'multi', 'q'=>'【多选】环境问题对国家安全的影响包括？', 'opt'=>['A. 危害公众健康','B. 制约经济发展','C. 引发社会动荡','D. 增强军事实力'], 'ans'=>'ABC', 'expl'=>'D错误，环境问题通常削弱综合国力。'],
                ['type'=>'multi', 'q'=>'【多选】突发环境事件的特点？', 'opt'=>['A. 发生突然','B. 破坏力强','C. 容易控制','D. 影响深远'], 'ans'=>'ABD', 'expl'=>'往往难以控制。']
            ],
            'part_b' => [
                ['title'=>'📉 倒U型的陷阱', 'q'=>'我们一定要走“先污染，后治理”的老路吗？', 'ans'=>'<b>不一定。</b><br>那是发达国家的教训。我们可以利用后发优势，采用清洁生产技术，发展循环经济，争取让库兹涅茨曲线变得<b>平缓</b>，甚至跨过污染高峰，直接实现绿色发展。'],
                ['title'=>'🎣 琵琶湖的教训', 'q'=>'日本琵琶湖水质恶化，导致了什么后果？', 'ans'=>'1. <b>供给受损</b>：水不能喝了，鱼死光了。<br>2. <b>调节受损</b>：赤潮频发，生态失衡。<br>3. <b>社会代价</b>：花了30年和巨额资金才勉强恢复。这说明<b>预防</b>比治理便宜得多。']
            ]
        ]
    ],
    ...
    'xb3c2s1' => [
        ...
        'ppt' => [
            ['role'=>'po', 'title'=>'神龙大侠的包子危机', 'content'=>'大家好！我是<b>阿宝</b>。如果和平谷的包子铺突然没有面粉了，大家就会饿肚子，可能会为了抢包子打架，整个山谷都会乱套！<br>这就是<b>资源安全</b>问题。<br>资源不仅是生活的必需品，更是国家安全（National Security）的基石。', 'visual'=>'icon_life', 'anim_type'=>'fadeIn'],
            ['role'=>'shifu', 'title'=>'战略资源的赌局', 'content'=>'我是<b>师父</b>。1980年，美国两位教授打赌：10年后金属价格是涨还是跌？<br>结果赌“跌”的赢了。<br>为什么资源越来越少，价格反而跌了？<br>因为<b>技术进步</b>（替代品出现、开采率提高）和<b>市场调节</b>。但这并不意味着资源安全没问题！', 'visual'=>'icon_chart', 'anim_type'=>'slideInLeft'],
            ['role'=>'tigress', 'title'=>'供需失衡的风险', 'content'=>'我是<b>悍娇虎</b>。资源安全的核心是<b>供给与需求</b>的平衡。<br>如果供给中断（如战争、禁运），或者需求突然暴增，安全红灯就会亮起。<br>资源短缺会引发经济危机，甚至军事冲突（如中东石油战争）。', 'visual'=>'icon_alert_red', 'anim_type'=>'rotateIn'],
            ['role'=>'ping', 'title'=>'案例：“的确良”救了棉花', 'content'=>'我是<b>平先生</b>。70年代，中国人口多，棉花不够穿。<br>后来我们引进了化纤技术，生产<b>“的确良”</b>（不用地里长出来的布）。<br>这不仅解决了穿衣问题，还省下了种棉花的土地去种粮食。<br><b>科技创新</b>是保障资源安全的神器！', 'visual'=>'icon_clothing', 'anim_type'=>'zoomIn'],
            ['role'=>'shifu', 'title'=>'保障安全的途径', 'content'=>'为师教你几招：<br>1. <b>开源</b>：挖掘潜力，寻找替代资源（如光伏代替煤炭）。<br>2. <b>节流</b>：提高利用率，节约使用。<br>3. <b>储备</b>：建立战略储备库（比如阿宝的零食库）。<br>4. <b>合作</b>：国际贸易，互通有无。', 'visual'=>'icon_shield', 'anim_type'=>'slideInUp'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，记住：<br>1. 资源安全关乎国家生死存亡。<br>2. 供需平衡是关键。<br>3. 科技能缓解资源短缺（如化纤）。<br>4. 开源节流、储备合作是四大法宝。<br>准备好接受师父的考核了吗？', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'资源安全的核心问题是？', 'opt'=>['A. 资源价格越低越好','B. 资源储备越多越好','C. 资源供给与需求的平衡','D. 停止开发保护环境'], 'ans'=>'C', 'expl'=>'资源安全本质上是保障资源供给能够满足合理需求。'],
                ['type'=>'single', 'q'=>'“的确良”（化纤）的普及，主要缓解了我国哪种资源的压力？', 'opt'=>['A. 水资源','B. 石油资源','C. 耕地资源（棉田）','D. 森林资源'], 'ans'=>'C', 'expl'=>'化纤替代棉花，减少了棉花种植面积，腾出了耕地用于生产粮食。'],
                ['type'=>'single', 'q'=>'下列不属于保障资源安全主要途径的是？', 'opt'=>['A. 挖掘资源潜力','B. 开发替代资源','C. 限制所有资源开发','D. 增加区外资源调配'], 'ans'=>'C', 'expl'=>'应合理开发利用，而非全面限制。'],
                ['type'=>'single', 'q'=>'战略性矿产资源出现供应危机，可能直接导致？', 'opt'=>['A. 生物多样性增加','B. 经济发展受阻，甚至国家安全受威胁','C. 气候变暖减缓','D. 人口出生率下降'], 'ans'=>'B', 'expl'=>'战略资源关乎国计民生和国防安全。'],
                ['type'=>'single', 'q'=>'美国西蒙教授打赌赢了，说明了什么对资源稀缺性的缓解作用？', 'opt'=>['A. 战争掠夺','B. 科技进步与市场机制','C. 人口减少','D. 资源再生'], 'ans'=>'B', 'expl'=>'技术进步提高了开采能力或发现了替代品，市场价格调节了供需。'],
                ['type'=>'single', 'q'=>'建立石油战略储备的主要目的是？', 'opt'=>['A. 控制国际油价','B. 应对突发事件导致的中断，保障短期供应','C. 垄断石油市场','D. 增加石油产量'], 'ans'=>'B', 'expl'=>'战略储备是为了应对战争、灾害等导致的供应中断风险。'],
                ['type'=>'single', 'q'=>'稀土被称为“工业维生素”，其安全属于？', 'opt'=>['A. 能源安全','B. 粮食安全','C. 战略矿产资源安全','D. 水资源安全'], 'ans'=>'C', 'expl'=>'稀土是关键的战略矿产。'],
                ['type'=>'multi', 'q'=>'【多选】影响资源供给安全的因素有？', 'opt'=>['A. 资源本身的稀缺性','B. 运输通道的安全','C. 国际市场的价格波动','D. 地缘政治局势'], 'ans'=>'ABCD', 'expl'=>'生产、运输、市场、政治都会影响供给。'],
                ['type'=>'multi', 'q'=>'【多选】开发替代资源是保障资源安全的重要途径，例如？', 'opt'=>['A. 以铝代铜','B. 煤变油（液化）','C. 太阳能发电替代火电','D. 塑料替代钢铁'], 'ans'=>'ABCD', 'expl'=>'材料替代和能源替代。'],
                ['type'=>'multi', 'q'=>'【多选】国家资源安全体系包括？', 'opt'=>['A. 建立预警机制','B. 完善法律法规','C. 储备战略资源','D. 禁止国际贸易'], 'ans'=>'ABC', 'expl'=>'D错误，应利用国际市场。']
            ],
            'part_b' => [
                ['title'=>'🐼 阿宝的包子', 'q'=>'如果和平谷的包子铺每天只能做100个包子，但阿宝每天要吃200个。这会造成什么后果？如何解决？', 'ans'=>'<b>资源短缺（不安全）。</b><br>后果：其他人没包子吃，引发社会动荡。解决：1. <b>开源</b>（多开几家包子铺）；2. <b>节流</b>（阿宝减肥，少吃点）；3. <b>替代</b>（改吃面条）。'],
                ['title'=>'🪨 稀土的秘密', 'q'=>'为什么说卖稀土像卖土一样便宜是危及国家安全的？', 'ans'=>'<b>战略价值流失。</b><br>稀土是制造导弹、芯片的关键原料。如果廉价大量出口，不仅耗尽本国战略储备，还可能让对手低成本制造先进武器反过来威胁我们。必须管控出口，提升附加值。'],
                ['title'=>'📱 手机里的矿', 'q'=>'你的手机里有金、银、铜、锂等几十种矿产。如果刚果（金）发生内战，为什么你的手机可能会涨价？', 'ans'=>'<b>全球供应链风险。</b><br>刚果（金）是重要的钴矿产地（锂电池原料）。产地动荡导致原料供给中断，全球电池成本上升，最终传导到手机价格。这也体现了资源安全的全球性。']
            ]
        ]
    ],
    ...
    'xb3c2s2' => [
        'title' => '2.2 中国的能源安全',
        'ppt' => [
            ['role'=>'po', 'title'=>'功夫与能量', 'content'=>'练功夫需要“气”，国家发展需要<b>“能源”</b>。<br>石油、煤炭、天然气，就是国家的内力。<br>我们中国是能源大国，但也面临挑战：<br><b>“富煤、少油、缺气、丰水、多风”</b>。<br>这个天赋点得有点偏科啊！', 'visual'=>'icon_fire', 'anim_type'=>'fadeIn'],
            ['role'=>'tigress', 'title'=>'煤炭：老大哥的烦恼', 'content'=>'我是悍娇虎。煤炭是我们最主要的能源（占60%左右）。<br><b>优点：</b> 储量大，自己有，安全。<br><b>缺点：</b> 脏！烧煤由于排放CO2和烟尘，是雾霾和气候变暖的元凶。<br><b>策略：</b> 清洁利用（煤变油、超低排放）。', 'visual'=>'icon_coal', 'anim_type'=>'slideInLeft'],
            ['role'=>'shifu', 'title'=>'石油：脆弱的血管', 'content'=>'我是师父。石油是工业的血液。<br>我们的石油一大半靠进口（对外依存度>70%）。<br>进口通道（马六甲海峡）一旦被卡住，后果不堪设想。<br><b>策略：</b> 1. 多元化进口（俄罗斯、中亚管道）。2. 建立战略石油储备。', 'visual'=>'icon_oil', 'anim_type'=>'rotateIn'],
            ['role'=>'ping', 'title'=>'历史：公交车上的大气包', 'content'=>'我是平先生。以前北京的公交车顶着个巨大的橡胶袋（P33）。<br>那是<b>煤气包</b>！<br>因为当时咱们缺石油，只能烧煤气。<br>现在我们有了大庆油田，有了进口石油，那个时代一去不复返了。', 'visual'=>'icon_bus', 'anim_type'=>'zoomIn'],
            ['role'=>'po', 'title'=>'未来：清洁能源', 'content'=>'为了蓝天白云，我们要换“新气”。<br><b>风能、太阳能、水电、核能</b>。<br>这些是非化石能源，清洁、可再生。<br>目标：<b>碳达峰、碳中和</b>！让和平谷永远山清水秀。', 'visual'=>'icon_wind', 'anim_type'=>'slideInUp'],
            ['role'=>'shifu', 'title'=>'能源安全战略', 'content'=>'总结一下我们的绝世武功：<br>1. <b>节能优先</b>：别浪费。<br>2. <b>立足国内</b>：把饭碗端在自己手里（煤炭兜底）。<br>3. <b>绿色低碳</b>：大力发展新能源。<br>4. <b>国际合作</b>：一带一路能源互联。', 'visual'=>'icon_shield', 'anim_type'=>'fadeIn'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，汇报重点：<br>1. 中国富煤少油缺气。<br>2. 石油进口风险大，需要储备。<br>3. 煤炭要清洁利用。<br>4. 新能源是未来方向。<br>准备考核！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'我国能源资源禀赋的特点是？', 'opt'=>['A. 富油、少气、缺煤','B. 富煤、少油、缺气','C. 富气、少煤、缺油','D. 各种能源都非常丰富'], 'ans'=>'B', 'expl'=>'“富煤、少油、缺气、丰水、多风”是我国基本国情。'],
                ['type'=>'single', 'q'=>'目前我国能源消费结构中，占比最高的是？', 'opt'=>['A. 石油','B. 天然气','C. 煤炭','D. 水电'], 'ans'=>'C', 'expl'=>'煤炭长期占据主导地位，虽然比重在下降，但仍最高。'],
                ['type'=>'single', 'q'=>'保障我国石油安全的重要措施不包括？', 'opt'=>['A. 建立国家战略石油储备','B. 拓展进口渠道，实现多元化','C. 彻底停止使用石油','D. 发展煤变油技术'], 'ans'=>'C', 'expl'=>'石油是重要原料和燃料，彻底停用不现实。'],
                ['type'=>'single', 'q'=>'20世纪50年代北京公交车顶的“大气包”装的是？', 'opt'=>['A. 天然气','B. 煤气','C. 氢气','D. 氧气'], 'ans'=>'B', 'expl'=>'当时石油短缺，使用常压煤气作为替代燃料。'],
                ['type'=>'single', 'q'=>'我国石油对外依存度高，主要的进口海上通道是？', 'opt'=>['A. 苏伊士运河','B. 巴拿马运河','C. 马六甲海峡','D. 霍尔木兹海峡'], 'ans'=>'C', 'expl'=>'中东和非洲的石油运往中国主要经过马六甲海峡，被称为“海上生命线”。'],
                ['type'=>'single', 'q'=>'发展风能、太阳能等非化石能源的主要意义是？', 'opt'=>['A. 降低能源成本','B. 优化能源结构，减少碳排放','C. 取代所有化石能源','D. 增加煤炭消耗'], 'ans'=>'B', 'expl'=>'清洁能源有助于实现碳达峰、碳中和目标。'],
                ['type'=>'single', 'q'=>'“西气东输”工程对我国能源安全的作用是？', 'opt'=>['A. 解决西部能源短缺','B. 缓解东部能源紧张，改善大气环境','C. 增加石油出口','D. 减少天然气进口'], 'ans'=>'B', 'expl'=>'将西部资源优势转化为经济优势，优化东部能源结构。'],
                ['type'=>'multi', 'q'=>'【多选】我国能源安全面临的挑战？', 'opt'=>['A. 能源需求持续增长','B. 化石能源造成的环境压力大','C. 油气资源进口依赖度高','D. 可再生能源技术完全成熟'], 'ans'=>'ABC', 'expl'=>'D不准确，技术仍在发展中，且面临消纳难题。'],
                ['type'=>'multi', 'q'=>'【多选】煤炭的清洁利用包括？', 'opt'=>['A. 煤炭洗选','B. 煤炭气化、液化','C. 燃煤超低排放改造','D. 直接燃烧原煤'], 'ans'=>'ABC', 'expl'=>'直接燃烧污染最大。'],
                ['type'=>'multi', 'q'=>'【多选】中俄天然气管道的开通有利于？', 'opt'=>['A. 增加我国清洁能源供应','B. 消除我国能源安全风险','C. 促进能源进口多元化','D. 深化中俄战略合作'], 'ans'=>'ACD', 'expl'=>'只能缓解风险，不能完全消除。']
            ],
            'part_b' => [
                ['title'=>'🚗 电动车的使命', 'q'=>'为什么国家大力补贴阿宝买电动汽车（新能源车），而不是燃油车？', 'ans'=>'<b>减少石油依赖 + 环保。</b><br>燃油车烧油，油主要靠进口，不安全且污染大。电动车用电，电可以用煤、风、光发，主要靠国内资源，既保障了能源安全，又减少了尾气排放。'],
                ['title'=>'🚢 马六甲的困局', 'q'=>'悍娇虎说：“我们的石油大动脉被人掐着脖子。”指的是哪里？怎么破局？', 'ans'=>'<b>马六甲海峡。</b><br>大部分进口石油都要经过这里，一旦被封锁就断油了。破局：1. <b>陆路管道</b>（中俄、中哈、中缅油气管道）；2. <b>北极航道</b>；3. <b>自力更生</b>（加大国内勘探）。'],
                ['title'=>'🔥 煤炭的底气', 'q'=>'既然煤炭污染大，为什么我们不直接把煤矿都关了？', 'ans'=>'<b>煤炭是压舱石。</b><br>我国“富煤”，煤炭是自己手里最可靠的能源。在新能源不稳定（没风没光）的时候，必须靠煤电来保底。所以不能关，只能<b>清洁利用</b>。']
            ]
        ]
    ],

    // --- XB3 2.3 中国的耕地资源与粮食安全 ---
    'xb3c2s3' => [
        'title' => '2.3 中国的耕地资源与粮食安全',
        'ppt' => [
            ['role'=>'ping', 'title'=>'谁来养活中国？', 'content'=>'我是平先生，我是做面条的。90年代有个外国人问：“谁来养活中国？”<br>我们用实际行动回答：<b>中国人自己养活自己！</b><br>我们的“谷物”基本自给，口粮绝对安全。<br>手中有粮，心中不慌！', 'visual'=>'icon_wheat', 'anim_type'=>'fadeIn'],
            ['role'=>'po', 'title'=>'耕地红线：18亿亩', 'content'=>'我是阿宝。耕地是粮食的妈妈。<br>中国山多地少，耕地非常珍贵。<br>我们划了一条红线：<b>18亿亩</b>。<br>这就像翡翠宫的围墙，绝对不能突破！<br>不管盖房子还是修路，都不能乱占耕地。', 'visual'=>'icon_alert_red', 'anim_type'=>'slideInLeft'],
            ['role'=>'shifu', 'title'=>'耕地的质量问题', 'content'=>'我是师父。光有数量不够，还得有质量。<br>我国耕地“先天不足”：中低产田占了2/3。<br>“后天失调”：污染、退化（黑土变瘦）、水土流失。<br>所以要建设<b>高标准农田</b>，旱涝保收，高产稳产。', 'visual'=>'icon_soil_layers', 'anim_type'=>'rotateIn'],
            ['role'=>'tigress', 'title'=>'藏粮于地，藏粮于技', 'content'=>'我是悍娇虎。这是我们的新战略。<br><b>藏粮于地</b>：保护好耕地，地在粮就在。<br><b>藏粮于技</b>：靠科技（袁隆平爷爷的杂交水稻、无人机施肥）提高产量。<br>不用屯那么多陈粮，地里随时能长出来，才是真安全。', 'visual'=>'icon_satellite', 'anim_type'=>'zoomIn'],
            ['role'=>'ping', 'title'=>'粮食进口怎么看？', 'content'=>'我们虽然口粮（大米小麦）够吃，但大豆和玉米还要进口（做饲料养猪，做油）。<br><b>适度进口</b>是必要的，可以调节余缺。<br>但不能太依赖，万一别人不卖了呢？<br>所以我们要把饭碗端在自己手里，而且要装中国粮！', 'visual'=>'icon_ship', 'anim_type'=>'shake'],
            ['role'=>'po', 'title'=>'光盘行动', 'content'=>'阿宝我虽然爱吃，但绝不浪费！<br>节约粮食就是最大的增产。<br>中国每年浪费的粮食够养活几千万人。<br>从我做起，吃多少点多少，这也是维护国家安全哦！', 'visual'=>'icon_life', 'anim_type'=>'slideInUp'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，汇报重点：<br>1. 粮食安全是国家安全的基础。<br>2. 严守18亿亩耕地红线。<br>3. 实施藏粮于地、藏粮于技。<br>4. 适度进口，节约粮食。<br>准备考核！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'我国粮食安全战略的底线是？', 'opt'=>['A. 粮食完全自给','B. 口粮绝对安全，谷物基本自给','C. 依赖国际市场','D. 大量进口肉类'], 'ans'=>'B', 'expl'=>'我们的目标是确保口粮（大米、小麦）绝对安全。'],
                ['type'=>'single', 'q'=>'我国划定的耕地红线是？', 'opt'=>['A. 15亿亩','B. 18亿亩','C. 20亿亩','D. 22亿亩'], 'ans'=>'B', 'expl'=>'18亿亩是保障14亿人口吃饭的底线。'],
                ['type'=>'single', 'q'=>'“藏粮于地”是指？', 'opt'=>['A. 把粮食埋在地里储存','B. 保护耕地生产能力，确保需要时能产出','C. 增加粮食仓库数量','D. 停止耕作让土地休息'], 'ans'=>'B', 'expl'=>'强调的是保护耕地的生产潜力。'],
                ['type'=>'single', 'q'=>'我国耕地资源的特点是？', 'opt'=>['A. 总量大，人均多','B. 总体质量高','C. 后备资源充足','D. 人均耕地少，优质耕地少'], 'ans'=>'D', 'expl'=>'人多地少，中低产田比例大。'],
                ['type'=>'single', 'q'=>'目前我国进口量最大的农产品主要是？', 'opt'=>['A. 大米','B. 小麦','C. 大豆','D. 玉米'], 'ans'=>'C', 'expl'=>'大豆主要用于榨油和饲料（豆粕），对外依存度极高。'],
                ['type'=>'single', 'q'=>'提高粮食产量的根本出路在于？', 'opt'=>['A. 大规模开垦荒地','B. 依靠科技进步（藏粮于技）','C. 增加化肥使用','D. 围湖造田'], 'ans'=>'B', 'expl'=>'耕地数量有限，增产主要靠单产提高（科技）。'],
                ['type'=>'single', 'q'=>'下列行为不利于粮食安全的是？', 'opt'=>['A. 建设高标准农田','B. 餐饮浪费','C. 推广良种','D. 完善粮食储备'], 'ans'=>'B', 'expl'=>'浪费是粮食安全的隐形杀手。'],
                ['type'=>'multi', 'q'=>'【多选】我国耕地保护面临的压力有？', 'opt'=>['A. 城市化建设占用','B. 水土流失和荒漠化','C. 土壤污染','D. 农业结构调整（非粮化）'], 'ans'=>'ABCD', 'expl'=>'耕地数量减少和质量下降的双重压力。'],
                ['type'=>'multi', 'q'=>'【多选】“藏粮于技”包括？', 'opt'=>['A. 培育优良品种','B. 推广机械化耕作','C. 发展节水灌溉','D. 提高气象灾害防御能力'], 'ans'=>'ABCD', 'expl'=>'农业科技的方方面面。'],
                ['type'=>'multi', 'q'=>'【多选】保障粮食安全的措施？', 'opt'=>['A. 严格保护耕地','B. 加强粮食储备','C. 建立国际稳定的贸易渠道','D. 鼓励大家少吃饭'], 'ans'=>'ABC', 'expl'=>'D是不合理的。']
            ],
            'part_b' => [
                ['title'=>'🍜 平先生的面馆', 'q'=>'平先生的面馆如果全靠进口面粉，会有什么风险？', 'ans'=>'<b>供应中断风险。</b><br>如果出口国发生灾害减产，或者两国关系不好不卖了，平先生的面馆就得关门，阿宝就没饭吃。所以必须要有自己的麦田（国内生产），进口只能作为补充。'],
                ['title'=>'🌱 土地在休息', 'q'=>'为什么有些地方的耕地今年不种粮食，而是种草或者休耕？这是浪费吗？', 'ans'=>'<b>不是浪费，是轮作休耕。</b><br>土地累了也需要休息。种草或休耕是为了恢复地力，治理污染（如地下水超采）。这正是“藏粮于地”的体现，为了将来能长出更好的粮食。'],
                ['title'=>'🚜 袁隆平的魔术', 'q'=>'地还是那块地，为什么粮食产量翻了一倍？', 'ans'=>'<b>藏粮于技（种子技术）。</b><br>通过杂交水稻等优良品种的培育，提高了单位面积的产量。科技是突破资源瓶颈（耕地少）的关键。']
            ]
        ]
    ],

    // --- XB3 2.4 海洋空间资源开发与国家安全 ---
    'xb3c2s4' => [
        'title' => '2.4 海洋空间资源开发与国家安全',
        'ppt' => [
            ['role'=>'po', 'title'=>'蓝色的国土', 'content'=>'嘿！我是阿宝。我们不仅有黄土地，还有蓝色的海洋。<br>海洋是生命的摇篮，也是资源的宝库。<br><b>海洋空间</b>包括：海面、海水、海底、海岸带。<br>这都是我们的“蓝色国土”！', 'visual'=>'icon_sea', 'anim_type'=>'fadeIn'],
            ['role'=>'shifu', 'title'=>'海洋空间开发', 'content'=>'我是师父。海洋能做什么？<br>1. <b>交通</b>：港口、航线（如马六甲海峡）。<br>2. <b>生产</b>：海上风电、钻井平台、海洋牧场（养鱼）。<br>3. <b>居住</b>：人工岛、海上城市。<br>4. <b>储藏</b>：海底光缆、海底隧道。', 'visual'=>'icon_ship', 'anim_type'=>'slideInLeft'],
            ['role'=>'tigress', 'title'=>'海洋与国家安全', 'content'=>'我是悍娇虎。海洋是国防的屏障。<br>拥有的海域越广，战略纵深越大。<br><b>岛屿</b>非常重要！它不仅是落脚点，更是划定领海和专属经济区的基点。<br>守住岛屿，就是守住海洋权益！', 'visual'=>'icon_shield', 'anim_type'=>'rotateIn'],
            ['role'=>'crane', 'title'=>'案例：永兴岛', 'content'=>'我是仙鹤。飞越南海，看到<b>三沙市</b>政府驻地——<b>永兴岛</b>。<br>它虽然小，但意义重大。<br>通过填海造陆，扩建了机场和码头。<br>加强了我们对南海的管控，维护了国家主权。', 'visual'=>'icon_island', 'anim_type'=>'zoomIn'],
            ['role'=>'po', 'title'=>'海洋权益知多少', 'content'=>'根据《联合国海洋法公约》：<br>1. <b>领海</b>：12海里（这是家门口，绝对主权）。<br>2. <b>毗连区</b>：再往外12海里。<br>3. <b>专属经济区</b>：200海里（资源归我，别人可以路过）。<br>4. <b>大陆架</b>：海底延伸部分。', 'visual'=>'icon_radar', 'anim_type'=>'shake'],
            ['role'=>'shifu', 'title'=>'维护权益', 'content'=>'怎么保护我们的海？<br>1. <b>理直气壮</b>：依据历史和国际法（如九段线）。<br>2. <b>实力说话</b>：建设强大海军和海警。<br>3. <b>开发利用</b>：你不去开发，别人就占了。<br>搁置争议，共同开发，但主权属我！', 'visual'=>'icon_integration', 'anim_type'=>'slideInUp'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，汇报重点：<br>1. 海洋空间是重要资源。<br>2. 岛屿是海上的战略支点。<br>3. 记住领海12海里，专属经济区200海里。<br>4. 坚决维护国家海洋权益！<br>任务完成，去海边吃海鲜咯！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'《联合国海洋法公约》规定，领海宽度为？', 'opt'=>['A. 12海里','B. 24海里','C. 200海里','D. 350海里'], 'ans'=>'A', 'expl'=>'领海是沿海国主权管辖的水域，宽度为12海里。'],
                ['type'=>'single', 'q'=>'专属经济区的范围通常是领海基线向外延伸至？', 'opt'=>['A. 12海里','B. 24海里','C. 200海里','D. 350海里'], 'ans'=>'C', 'expl'=>'在专属经济区内，沿海国享有资源开发的主权权利。'],
                ['type'=>'single', 'q'=>'永兴岛的开发建设对国家安全的意义主要体现在？', 'opt'=>['A. 增加旅游收入','B. 宣示主权，维护海洋权益','C. 解决人口拥挤','D. 开采石油'], 'ans'=>'B', 'expl'=>'永兴岛是三沙市政府驻地，具有重要的政治、军事和战略意义。'],
                ['type'=>'single', 'q'=>'下列不属于海洋空间资源的是？', 'opt'=>['A. 海洋生物','B. 海底隧道','C. 跨海大桥','D. 海上机场'], 'ans'=>'A', 'expl'=>'海洋生物属于海洋生物资源，不是空间资源。'],
                ['type'=>'single', 'q'=>'我国拥有的海洋权益不包括？', 'opt'=>['A. 领海主权','B. 专属经济区资源管辖权','C. 公海的绝对独占权','D. 大陆架资源勘探权'], 'ans'=>'C', 'expl'=>'公海属于全人类共同继承财产，各国均有使用权，不能独占。'],
                ['type'=>'single', 'q'=>'围海造陆（如填海造机场）利用的是？', 'opt'=>['A. 海面及水体资源','B. 海岸带及滩涂资源','C. 深海海底资源','D. 海洋生物资源'], 'ans'=>'B', 'expl'=>'填海造陆主要发生在浅海滩涂区域。'],
                ['type'=>'single', 'q'=>'维护海洋权益的手段不包括？', 'opt'=>['A. 加强海上执法','B. 进行海洋科学考察','C. 放弃争议岛屿','D. 完善海洋法律法规'], 'ans'=>'C', 'expl'=>'放弃岛屿是丧失权益的行为。'],
                ['type'=>'multi', 'q'=>'【多选】海洋空间资源的特点？', 'opt'=>['A. 环境恶劣（高压、腐蚀）','B. 技术难度大','C. 资金投入高','D. 具有立体性'], 'ans'=>'ABCD', 'expl'=>'海洋开发面临风浪、盐雾等挑战，是高技术高投入领域。'],
                ['type'=>'multi', 'q'=>'【多选】海洋对国家安全的作用？', 'opt'=>['A. 资源宝库','B. 贸易通道','C. 国防屏障','D. 污染排放地'], 'ans'=>'ABC', 'expl'=>'D是负面利用，不符合安全理念。'],
                ['type'=>'multi', 'q'=>'【多选】三沙市设立的意义？', 'opt'=>['A. 便于行政管理','B. 加强南海资源开发','C. 保护南海生态环境','D. 维护国家主权'], 'ans'=>'ABCD', 'expl'=>'三沙市统管西沙、中沙、南沙群岛及其海域。']
            ],
            'part_b' => [
                ['title'=>'🏝️ 消失的岛屿', 'q'=>'如果一个小岛被海水淹没变成了暗礁，国家会损失什么权益？', 'ans'=>'<b>领海和专属经济区。</b><br>根据国际法，适合人类居住的岛屿可以拥有12海里领海和200海里专属经济区。如果变成了不露出水面的暗礁或无法居住的岩礁，这些巨大的海域权益可能就会丧失。所以我们要保护岛屿。'],
                ['title'=>'🛳️ 自由航行', 'q'=>'外国军舰可以在我国的专属经济区内自由航行吗？', 'ans'=>'<b>可以航行，但不能搞事。</b><br>专属经济区不是领海。他国享有航行和飞越自由，但不得进行资源勘探、捕鱼或危害沿海国安全的军事活动。必须遵守沿海国的法律法规。'],
                ['title'=>'🌉 填海的代价', 'q'=>'填海造陆虽然增加了土地，但也带来了什么坏处？', 'ans'=>'<b>生态破坏。</b><br>破坏了滨海湿地、红树林和珊瑚礁，导致生物多样性减少，还会改变洋流，减弱海岸抵御风暴潮的能力。所以现在国家严格管控填海。']
            ]
        ]
    ],
    ...
    'xb3c3s1' => [
        ...
        'ppt' => [
            ['role'=>'po', 'title'=>'看不见的敌人', 'content'=>'大家好！我是<b>阿宝</b>。我们以前对抗的是看得见的坏蛋（像泰龙），但现在有一个看不见的敌人——<b>环境问题</b>。<br>环境污染、生态退化、气候变暖……<br>如果不去管它，它会演变成<b>环境安全问题</b>，甚至威胁到我们的国家安全！', 'visual'=>'icon_storm', 'anim_type'=>'fadeIn'],
            ['role'=>'shifu', 'title'=>'环境安全的底线', 'content'=>'我是<b>师父</b>。什么是环境安全？<br>就是自然环境能够支撑我们生存，不会因为环境问题导致社会崩溃。<br><b>临界值</b>：环境问题就像压在骆驼身上的稻草，一旦超过某个限度（临界值），骆驼就垮了，这就是环境安全危机。', 'visual'=>'icon_chart', 'anim_type'=>'slideInLeft'],
            ['role'=>'tigress', 'title'=>'如何威胁国家安全？', 'content'=>'我是<b>悍娇虎</b>。环境问题会引发连锁反应：<br>1. <b>经济安全</b>：资源枯竭，工厂停工。<br>2. <b>社会安全</b>：环境难民流离失所，引发骚乱。<br>3. <b>政治安全</b>：政府公信力下降。<br>4. <b>军事安全</b>：争夺水和资源的战争。', 'visual'=>'icon_alert_red', 'anim_type'=>'rotateIn'],
            ['role'=>'ping', 'title'=>'案例：打赌的故事', 'content'=>'我是<b>平先生</b>。还记得那个打赌吗？<br>1995年，埃尔里奇又和西蒙打赌了。这次赌的是“环境指标”。<br>埃尔里奇认为环境会变坏（气温升高、雨林减少）。<br>结果他赢了！<br>这说明：<b>环境确实在恶化</b>，我们的安全在流失。', 'visual'=>'icon_compare', 'anim_type'=>'zoomIn'],
            ['role'=>'shifu', 'title'=>'应对之道', 'content'=>'怎么保护自己？<br>1. <b>源头防控</b>：减少污染排放（不乱扔垃圾）。<br>2. <b>过程治理</b>：出了问题赶紧修（种树治沙）。<br>3. <b>应急响应</b>：遇到灾难有预案（如防洪演习）。<br>降低风险，就是守护安全。', 'visual'=>'icon_shield', 'anim_type'=>'slideInUp'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，汇报重点：<br>1. 环境安全是国家安全的保障。<br>2. 环境问题有临界值，不能越界。<br>3. 环境恶化会引发经济、社会危机。<br>4. 全程防控降低风险。<br>准备好接受师父的考核了吗？', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'环境安全是指？', 'opt'=>['A. 环境中没有任何污染物','B. 自然环境能够支撑人类生存发展，不产生重大危害','C. 所有的自然资源都取之不尽','D. 彻底停止人类开发活动'], 'ans'=>'B', 'expl'=>'环境安全强调的是环境服务功能未受严重损害，能支撑社会运行。'],
                ['type'=>'single', 'q'=>'环境问题演变为环境安全问题的关键是？', 'opt'=>['A. 出现污染','B. 严重程度超过临界值（环境承载力）','C. 引起了媒体关注','D. 发生在城市'], 'ans'=>'B', 'expl'=>'量变引起质变，超过临界值才会导致系统崩溃。'],
                ['type'=>'single', 'q'=>'环境安全问题对国家安全的影响通常是？', 'opt'=>['A. 只有直接影响','B. 只有间接影响','C. 既有直接影响，也有通过经济、社会等领域的间接影响','D. 没有影响'], 'ans'=>'C', 'expl'=>'环境问题往往通过触发经济衰退、社会动荡来威胁国家安全。'],
                ['type'=>'single', 'q'=>'埃尔里奇第二次打赌（环境指标）赢了，说明？', 'opt'=>['A. 资源价格下跌','B. 科技能解决所有问题','C. 全球环境呈恶化趋势','D. 人类应该放弃发展'], 'ans'=>'C', 'expl'=>'全球气温升高、森林减少等事实证明环境在恶化。'],
                ['type'=>'single', 'q'=>'降低环境安全风险的根本途径是？', 'opt'=>['A. 提高应急能力','B. 降低人类社会脆弱性','C. 降低环境问题严重程度（源头防控）','D. 躲避高风险区'], 'ans'=>'C', 'expl'=>'从源头减少环境问题的发生是最根本的。'],
                ['type'=>'single', 'q'=>'下列属于环境安全问题引发政治安全危机的是？', 'opt'=>['A. 雾霾导致航班取消','B. 洪水淹没农田','C. 跨国水污染导致外交冲突','D. 噪音扰民'], 'ans'=>'C', 'expl'=>'外交冲突属于政治安全范畴。'],
                ['type'=>'single', 'q'=>'国家安全体系中，环境安全处于什么地位？', 'opt'=>['A. 核心地位','B. 基础地位','C. 无关紧要','D. 决定性地位'], 'ans'=>'B', 'expl'=>'环境安全是其他安全（经济、社会）的基础。'],
                ['type'=>'multi', 'q'=>'【多选】环境安全问题可能引发的后果？', 'opt'=>['A. 经济损失','B. 难民问题','C. 社会不稳定','D. 军事冲突'], 'ans'=>'ABCD', 'expl'=>'环境问题具有连锁反应。'],
                ['type'=>'multi', 'q'=>'【多选】应对环境安全风险的措施？', 'opt'=>['A. 加强环境监测','B. 制定应急预案','C. 发展循环经济','D. 掩盖环境真相'], 'ans'=>'ABC', 'expl'=>'D是错误的。'],
                ['type'=>'multi', 'q'=>'【多选】人类社会对环境风险的承受力取决于？', 'opt'=>['A. 经济发展水平','B. 科技水平','C. 治理能力','D. 人口数量'], 'ans'=>'ABC', 'expl'=>'经济越发达、技术越好，承受和修复能力越强。']
            ],
            'part_b' => [
                ['title'=>'🐫 压死骆驼的稻草', 'q'=>'师父说：“不要做压死骆驼的最后一根稻草。”在环境安全中，这根“稻草”代表什么？', 'ans'=>'<b>临界值（阈值）。</b><br>环境有自净能力，但有限度。当污染物积累到超过这个限度（稻草），环境系统就会突然崩溃，发生不可逆转的灾难（骆驼倒下）。'],
                ['title'=>'🍜 面馆的危机', 'q'=>'如果因为水污染，平先生做面条的水变臭了，这会怎么影响“国家安全”？', 'ans'=>'<b>从食品安全到社会稳定。</b><br>水污染（环境问题） -> 做不出面条（经济受损） -> 大家没饭吃、生病（社会问题） -> 抗议、抢夺资源（社会动荡、威胁国家安全）。'],
                ['title'=>'🌍 蝴蝶的翅膀', 'q'=>'为什么巴西砍伐雨林，可能会威胁到中国的国家安全？', 'ans'=>'<b>全球环境的整体性。</b><br>雨林砍伐导致全球变暖，海平面上升，极端天气增加。这会影响中国的农业生产（粮食安全）和沿海城市安全（国土安全）。环境安全是无国界的。']
            ]
        ]
    ],
    ...
    'xb3c3s2' => [
        'title' => '3.2 环境污染与国家安全',
        'ppt' => [
            ['role'=>'po', 'title'=>'突如其来的灾难', 'content'=>'我是阿宝。有些环境问题是慢慢来的（比如雾霾），有些却是突然爆发的！<br><b>突发环境事件</b>：像“深水地平线”钻井平台爆炸、松花江污染。<br>它们发生得快，危害大，很难防，直接冲击国家安全。', 'visual'=>'icon_alert_red', 'anim_type'=>'fadeIn'],
            ['role'=>'shifu', 'title'=>'案例：墨西哥湾漏油', 'content'=>'我是师父。2010年，美国墨西哥湾漏油。<br>后果：海洋生物大量死亡，渔民失业，旅游业重创。<br>这不仅是生态灾难，更是<b>经济灾难和社会危机</b>。<br>英国石油公司为此赔了数百亿美元！', 'visual'=>'icon_oil', 'anim_type'=>'slideInLeft'],
            ['role'=>'tigress', 'title'=>'污染物跨国转移', 'content'=>'我是悍娇虎。有些坏蛋把自己家的垃圾扔到别人家！<br>1. <b>自然扩散</b>：风把酸雨吹到邻国，河水把毒物带到下游。<br>2. <b>人为转移</b>：把洋垃圾、有毒废料出口到发展中国家。<br>这是极其不负责任的行为，会引发<b>外交纠纷</b>！', 'visual'=>'icon_ship', 'anim_type'=>'rotateIn'],
            ['role'=>'crane', 'title'=>'案例：松花江污染', 'content'=>'我是仙鹤。2005年，吉林化工厂爆炸，苯流入松花江。<br>这不仅影响了哈尔滨的供水，还流向了<b>俄罗斯</b>（黑龙江）。<br>这变成了<b>国际事件</b>！<br>中国政府及时通报、道歉、赔偿、合作治理，才化解了危机。', 'visual'=>'icon_water_drop', 'anim_type'=>'zoomIn'],
            ['role'=>'ping', 'title'=>'洋垃圾：拒绝！', 'content'=>'我是平先生。以前我们为了回收原料，进口过“洋垃圾”。<br>但这里面太脏了，处理起来污染我们的空气和水。<br>现在我们<b>禁止洋垃圾入境</b>！<br>我们不当世界的垃圾场，我们要守护自己的绿水青山。', 'visual'=>'icon_rebuild', 'anim_type'=>'shake'],
            ['role'=>'shifu', 'title'=>'应对：冲突与合作', 'content'=>'面对跨国污染，怎么办？<br><b>冲突</b>：互相指责，甚至打仗（下策）。<br><b>合作</b>：信息共享，联合执法，共同治理（上策）。<br>只有合作，才能共赢。', 'visual'=>'icon_integration', 'anim_type'=>'slideInUp'],
            ['role'=>'po', 'title'=>'全节总结', 'content'=>'大侠们，汇报重点：<br>1. 突发环境事件危害大，影响广。<br>2. 污染物跨国转移会引发外交危机。<br>3. 拒绝洋垃圾，守护国门。<br>4. 国际合作是解决跨国污染的关键。<br>准备考核！', 'visual'=>'icon_final', 'anim_type'=>'bounceIn']
        ],
        'quiz' => [
            'part_a' => [
                ['type'=>'single', 'q'=>'突发环境事件的特点不包括？', 'opt'=>['A. 发生的随机性和瞬时性','B. 成因的多样性','C. 危害的广泛性','D. 易于预测和控制'], 'ans'=>'D', 'expl'=>'突发事件通常难以预测，难以控制。'],
                ['type'=>'single', 'q'=>'2010年墨西哥湾漏油事件主要威胁了美国的？', 'opt'=>['A. 政治安全','B. 经济安全和生态安全','C. 军事安全','D. 文化安全'], 'ans'=>'B', 'expl'=>'渔业、旅游业受损（经济），海洋环境破坏（生态）。'],
                ['type'=>'single', 'q'=>'污染物跨国转移的主要方式有？', 'opt'=>['A. 只有自然扩散','B. 只有人为贸易','C. 自然扩散和人为转移','D. 宇宙输送'], 'ans'=>'C', 'expl'=>'风水自然输送，以及废弃物贸易等人为输送。'],
                ['type'=>'single', 'q'=>'中国全面禁止“洋垃圾”入境的原因是？', 'opt'=>['A. 国内资源已经过剩','B. 加工利用过程环境污染严重，危害健康','C. 国外垃圾价格太贵','D. 为了保护国外环境'], 'ans'=>'B', 'expl'=>'洋垃圾夹带大量有害物质，处理过程二次污染严重。'],
                ['type'=>'single', 'q'=>'应对跨国环境安全问题，最佳的方式是？', 'opt'=>['A. 军事对抗','B. 经济制裁','C. 国际合作','D. 封闭边境'], 'ans'=>'C', 'expl'=>'环境无国界，只有合作才能解决问题。'],
                ['type'=>'single', 'q'=>'松花江污染事件演变为涉外事件，是因为？', 'opt'=>['A. 污染物通过水流进入了中俄界河黑龙江','B. 爆炸工厂是外资企业','C. 受害者全是外国人','D. 媒体进行了虚假报道'], 'ans'=>'A', 'expl'=>'松花江汇入黑龙江（界河），影响了俄罗斯。'],
                ['type'=>'single', 'q'=>'下列属于污染物人为跨国转移的是？', 'opt'=>['A. 欧洲的酸雨飘到瑞典','B. 美国将电子垃圾出口到非洲','C. 日本核污水排海随洋流扩散','D. 澳大利亚沙尘暴吹到新西兰'], 'ans'=>'B', 'expl'=>'电子垃圾贸易是人为的废弃物转移。A、C、D主要是自然扩散（核污水虽为人排，但扩散靠洋流）。'],
                ['type'=>'multi', 'q'=>'【多选】突发环境事件对国家安全的间接影响？', 'opt'=>['A. 导致公众恐慌','B. 引发社会动荡','C. 降低政府公信力','D. 直接造成人员伤亡'], 'ans'=>'ABC', 'expl'=>'D是直接影响。'],
                ['type'=>'multi', 'q'=>'【多选】减少污染物跨国转移的措施？', 'opt'=>['A. 加强国际公约约束（如巴塞尔公约）','B. 提高发展中国家环保标准','C. 加强海关监管','D. 鼓励发达国家输出垃圾'], 'ans'=>'ABC', 'expl'=>'应限制发达国家输出垃圾。'],
                ['type'=>'multi', 'q'=>'【多选】环境安全冲突的表现形式？', 'opt'=>['A. 外交抗议','B. 贸易限制','C. 联合治理','D. 军事威胁'], 'ans'=>'ABD', 'expl'=>'联合治理是合作形式。']
            ],
            'part_b' => [
                ['title'=>'🗑️ 垃圾去哪了', 'q'=>'为什么发达国家喜欢把电子垃圾（旧电脑、手机）卖给发展中国家？', 'ans'=>'<b>成本转移。</b><br>发达国家环保标准高，处理垃圾费用贵。发展中国家急需原材料且环保标准低。发达国家通过“出口”，把污染和处理成本转嫁给了穷国，这是一种<b>环境不公</b>。'],
                ['title'=>'🌊 河流的责任', 'q'=>'如果您是松花江上游工厂的厂长，发生泄漏后第一件事该做什么？为什么？', 'ans'=>'<b>及时通报。</b><br>必须立刻通知下游（包括下游国家），让他们有时间关闭取水口、准备应急物资。隐瞒不报会错失最佳时机，导致后果扩大，甚至引发严重的外交危机。'],
                ['title'=>'🐼 功夫与底线', 'q'=>'阿宝说：“我们不能为了练功（发展经济）把练功房（环境）给拆了。”这句话对吗？', 'ans'=>'<b>对。</b><br>发展经济不能以牺牲环境为代价。如果环境被破坏了（练功房拆了），经济发展也就失去了基础（没地练功了）。这就是<b>可持续发展</b>的道理。']
            ]
        ]
    ],
